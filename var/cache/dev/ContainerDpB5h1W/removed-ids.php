...
return [
    '.1_DoctrineProvider~23ONHiD' => true,
    '.1_LegacyRouteLoaderContainer~ElWZJcN' => true,
    '.1_NativeFileSessionHandler~AlHtMjQ' => true,
    '.1_NonceGenerator~_9Q.kIt' => true,
    '.1_ResolvedFormTypeFactory~86x.9h3' => true,
    '.1_Serializer~qMi5Y4_' => true,
    '.1_ServiceLocator~xWwQUCJ' => true,
    '.1_SourceContextProvider~V5cxaio' => true,
    '.1_Swift_Transport_Esmtp_Auth_CramMd5Authenticator~zqKMOEC' => true,
    '.1_bool~tRFk580' => true,
    '.1_~oRCoXPt' => true,
    '.1_~zruV6.x' => true,
    '.2_ArrayAdapter~23ONHiD' => true,
    '.2_HtmlDumper~_9Q.kIt' => true,
    '.2_ObjectNormalizer~qMi5Y4_' => true,
    '.2_SourceContextProvider~V5cxaio' => true,
    '.2_Swift_Transport_Esmtp_Auth_LoginAuthenticator~zqKMOEC' => true,
    '.2_~oRCoXPt' => true,
    '.2_~zruV6.x' => true,
    '.3_RequestContextProvider~V5cxaio' => true,
    '.3_Swift_Transport_Esmtp_Auth_PlainAuthenticator~zqKMOEC' => true,
    '.4_CliContextProvider~V5cxaio' => true,
    '.4_Swift_Transport_Esmtp_Auth_NTLMAuthenticator~zqKMOEC' => true,
    '.5_CliDescriptor~V5cxaio' => true,
    '.6_HtmlDescriptor~V5cxaio' => true,
