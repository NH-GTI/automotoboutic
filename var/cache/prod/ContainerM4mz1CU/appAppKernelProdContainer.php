...
class appAppKernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'InstanWeb\\Module\\NHBusinessCentral\\Adapter\\Config\\BusinessCentralConfiguration' => 'getBusinessCentralConfigurationService.php',
            'InstanWeb\\Module\\NHBusinessCentral\\Controller\\TransactionDetailGridController' => 'getTransactionDetailGridControllerService.php',
            'InstanWeb\\Module\\NHBusinessCentral\\Controller\\TransactionGridController' => 'getTransactionGridControllerService.php',
            'InstanWeb\\Module\\NHBusinessCentral\\Factory\\TransactionDetailGridDefinitionFactory' => 'getTransactionDetailGridDefinitionFactoryService.php',
            'InstanWeb\\Module\\NHBusinessCentral\\Factory\\TransactionGridDefinitionFactory' => 'getTransactionGridDefinitionFactoryService.php',
            'InstanWeb\\Module\\NHBusinessCentral\\Form\\Type\\BusinessCentralConfiguration' => 'getBusinessCentralConfiguration2Service.php',
            'InstanWeb\\Module\\NHBusinessCentral\\Query\\TransactionDetailGridQueryBuilder' => 'getTransactionDetailGridQueryBuilderService.php',
            'InstanWeb\\Module\\NHBusinessCentral\\Query\\TransactionGridQueryBuilder' => 'getTransactionGridQueryBuilderService.php',
            ...
            'instanweb.module.nhbusinesscentral.businesscentralconfiguration.config.data' => 'getInstanweb_Module_Nhbusinesscentral_Businesscentralconfiguration_Config_DataService.php',
            'instanweb.module.nhbusinesscentral.businesscentralconfiguration.config.data.handler' => 'getInstanweb_Module_Nhbusinesscentral_Businesscentralconfiguration_Config_Data_HandlerService.php',
            'instanweb.module.nhbusinesscentral.transaction.grid.data.factory' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_Grid_Data_FactoryService.php',
            'instanweb.module.nhbusinesscentral.transaction.grid.factory' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_Grid_FactoryService.php',
            'instanweb.module.nhbusinesscentral.transaction.order' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_OrderService.php',
            'instanweb.module.nhbusinesscentral.transaction.order.communication' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_Order_CommunicationService.php',
            'instanweb.module.nhbusinesscentral.transaction.repository' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_RepositoryService.php',
            'instanweb.module.nhbusinesscentral.transactiondetail.grid.data.factory' => 'getInstanweb_Module_Nhbusinesscentral_Transactiondetail_Grid_Data_FactoryService.php',
            'instanweb.module.nhbusinesscentral.transactiondetail.grid.factory' => 'getInstanweb_Module_Nhbusinesscentral_Transactiondetail_Grid_FactoryService.php',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('yWlhkwnTVB', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'automotoboutic_ps8', 'user' => 'automotoboutic_ps8', 'password' => 'P5u$(!ZXwh*78sv', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I59oAmxk-u', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bXAMixeT3a', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vUQs57IU6l', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OuFvTKV3ha', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MYaXdqb6gP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KsCSMfg-8-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WqGxsRLIvp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x+z6Mbn6lR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GWT7LeKnvG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('gEB+6yC+sR', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FaviJvS-fH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dpRvYwJkOu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UZMH3MwHEx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rPDbj+KPQd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('WOrzYTsCfgsP0PJZLcFY05HEDVe3ETPKQqAoLRj3U12LWEmqFp8T50Stwe0qAyaG'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                67 => 'paypal',
                68 => 'netreviews',
                69 => 'nhbusinesscentral',
            ],
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => false,
            'database_host' => '127.0.0.1',
            'database_port' => '',
            'database_name' => 'automotoboutic_ps8',
            'database_user' => 'automotoboutic_ps8',
            'database_password' => 'P5u$(!ZXwh*78sv',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'WOrzYTsCfgsP0PJZLcFY05HEDVe3ETPKQqAoLRj3U12LWEmqFp8T50Stwe0qAyaG',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-10-31',
            'locale' => 'fr-FR',
            'use_debug_toolbar' => true,
            'cookie_key' => 'eq7hhHR1j6RXgoSKRe4uTtsXIECMh0CyA9vqjmYdEnbMmzzYZdkAfrNf5QqzVpg0',
            'cookie_iv' => 'NinID42gnLMkvNke0VXJrEiUWqFfnBVX',
            'new_cookie_key' => 'def000000bfb57d2e483bfc6a2cac1ea2e01d5886f152151e34be2c8f242747500d9e40bf4f395504bd597293976f6fbb31e61e04ad482a6f1d2b772e44c8dc69b7ff99d',
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQC7FR3YHexPT4k1'."\n".'QR1wcXkFLEdN9/lAzIEDOPWI3vg6fJzIacb/Gms+PiviCXsMUCY9aBG1kfAN3T4T'."\n".'SHMsfzHQMWXdrC2TL0g0Z94VuVIpkMM9egdEzQiH+16yUqQZqOgelI3tQVLWH0b4'."\n".'JmyiwjCbSMYn59X2mXz4G5hKA+fl7S12679J7s5Yknoe3D9/7qmQbx/oTuuyoAVi'."\n".'pCiTFE1tuD8tCCs8dYjOe5D7FI/9H89oEpYA+/FjodAWoFpEb2a4asOC2LHof8e3'."\n".'81xm12KjEa5ukIEGVPBr1HPI+YE7HQV9v39Q6ngSN4SiHZ+SfETV2/JujuxozCmy'."\n".'HOR+rX0VAgMBAAECggEBALCTHbf9hizVRQueicq3TyIyyJouknM2kg4YlKa6zE9n'."\n".'jhMaw1fD97SnuYN+r0TP4UfUEeLt+0UarJxGpW46HyoBdcPj3qAs4FmWL2cRoxrY'."\n".'J26+3l1xp7uw5ZApr/kIEw3J6KsmHKk8nB9bJO35myb1aRIBH1HBTNJgOTyisx2v'."\n".'P3fSrMWyP/NMdV3ShiYxDJswBXurFcnCcHAQ7htosyCQqdqwStIbIc9JigUYEGM6'."\n".'aeMtmTa7dqjLLlcap888+pR2LtQL3lRl4k0cHOZJQl1LGqX2xt4PoB5FqCE5vmGM'."\n".'KMrhvHvVaoqTK8F0UXI5hoW1GCYUAArYUoEb16a5UAECgYEA8BI7wT9zo0zOY1OF'."\n".'z+x5Wj5cb1VJt/nQG21O/e8nzdXDVALMKHz68A/5Yg9KpXAowTd6S7ER9nbQPJNg'."\n".'77z9CFhcUeVBsvJP6SozSf4FSqB/eeWf+UXO9uKfVgXTDlAudDNNbO4K7ZvdjpJx'."\n".'s3MkfDhG7CsLc1c5CGFRRs8McvUCgYEAx37Vt7+okg8GiU82PMAgNS4Qb3/hgRxv'."\n".'yfbqkAkkuUwv8TXH10x/z8twurasSz+1tbtsd/wg4s3SJIV2P9fyyqLeF0BgWyLu'."\n".'4adRLlf5yfpN5rlW2cbJhmQZ8LSTDG5l2aNmQSV7IKU+UmqnvRSR9A7VZcVATV6N'."\n".'UFuYhn+/zaECgYBVEqEKQioAXF9m41ov7GS0jhTDfz24bFZK4dl0MyOv1Wh6hONE'."\n".'FcX2/DIrha+2IKDQl5BG8mCjLkdsr+1SB27DXkyY2N0HRMb8oW+7cMD/SRDjaXPf'."\n".'KdXFt1kvarD4CYHsu6FcUJ6exPUmaM7SAKOVQXwghMByBx620YWzyftnYQKBgAGA'."\n".'9T9zVGP1dQkn7bK7iAKenEUa46pDepw9HjuDtiEnb90TmLQIwZXhZLIjmlze2BHM'."\n".'nd6xqdXL01+vGdsVV6ErZR0rwQ4uzzooNrZwt1NMbbXlg8AUfYRj0MY9tjYLxvzC'."\n".'/IxVKf5vAG9Cmo0UUJ1UV0tzFy7+HXaTmiy5XcrBAoGBALbPJX7M+Rh+o88pj4S+'."\n".'EufCkk+DCBqvj97qWxm1cEXx/FSfdWqqv1JzMssPj7JjBdrxWkJ7ZCwsidpXuTYu'."\n".'RGGvZikD/+7qFZzB60Se1E4hpwWzHP/8tdOkmGl5J8cDvQLb1CTeRdao0a4K0Au/'."\n".'ZagH4Srzx64U9XGHfgQTzbHp'."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                9 => (\dirname(__DIR__, 4).'/modules/ps_customtext/translations'),
                ...
                17 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                ...
                43 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                ...
                49 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/dpdfrance/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/lm_pushsurmesure/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/ecordersandstock/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/cmcicpaiement/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/lm_surmesure/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/sellermania/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/paypal/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/netreviews/translations'),
            ],
            ...
            'kernel.secret' => 'WOrzYTsCfgsP0PJZLcFY05HEDVe3ETPKQqAoLRj3U12LWEmqFp8T50Stwe0qAyaG',
