...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            'InstanWeb\\Module\\NHBusinessCentral\\Adapter\\Config\\BusinessCentralConfiguration' => 'getBusinessCentralConfigurationService',
            ...
            'instanweb.module.nhbusinesscentral.businesscentralconfiguration.config.data' => 'getInstanweb_Module_Nhbusinesscentral_Businesscentralconfiguration_Config_DataService',
            'instanweb.module.nhbusinesscentral.transaction.order' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_OrderService',
            'instanweb.module.nhbusinesscentral.transaction.order.communication' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_Order_CommunicationService',
            'instanweb.module.nhbusinesscentral.transaction.repository' => 'getInstanweb_Module_Nhbusinesscentral_Transaction_RepositoryService',
    ...
    /**
     * Gets the public 'InstanWeb\Module\NHBusinessCentral\Adapter\Config\BusinessCentralConfiguration' shared service.
     *
     * @return \InstanWeb\Module\NHBusinessCentral\Adapter\Config\BusinessCentralConfiguration
     */
    protected function getBusinessCentralConfigurationService()
    {
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/var/www/html/automotoboutic/modules/productcomments/src/Entity']);
        $e->addExcludePaths([0 => '/var/www/html/automotoboutic/modules/productcomments/src/Entity/index.php']);

        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/var/www/html/automotoboutic/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/var/www/html/automotoboutic/var/cache/prod//doctrine/orm/Proxies');
    ...
    /**
     * Gets the public 'instanweb.module.nhbusinesscentral.businesscentralconfiguration.config.data' shared service.
     *
     * @return \InstanWeb\Module\NHBusinessCentral\Provider\ConfigurationData
     */
    protected function getInstanweb_Module_Nhbusinesscentral_Businesscentralconfiguration_Config_DataService()
    {
        return $this->services['instanweb.module.nhbusinesscentral.businesscentralconfiguration.config.data'] = new \InstanWeb\Module\NHBusinessCentral\Provider\ConfigurationData(($this->services['InstanWeb\\Module\\NHBusinessCentral\\Adapter\\Config\\BusinessCentralConfiguration'] ?? $this->getBusinessCentralConfigurationService()));
    }

    /**
     * Gets the public 'instanweb.module.nhbusinesscentral.transaction.order' shared service.
     *
     * @return \InstanWeb\Module\NHBusinessCentral\Transaction\Order\Order
     */
    protected function getInstanweb_Module_Nhbusinesscentral_Transaction_OrderService()
    {
        return $this->services['instanweb.module.nhbusinesscentral.transaction.order'] = new \InstanWeb\Module\NHBusinessCentral\Transaction\Order\Order(($this->services['instanweb.module.nhbusinesscentral.transaction.repository'] ?? $this->getInstanweb_Module_Nhbusinesscentral_Transaction_RepositoryService()), ($this->services['instanweb.module.nhbusinesscentral.transaction.order.communication'] ?? $this->getInstanweb_Module_Nhbusinesscentral_Transaction_Order_CommunicationService()));
    }

    /**
     * Gets the public 'instanweb.module.nhbusinesscentral.transaction.order.communication' shared service.
     *
     * @return \InstanWeb\Module\NHBusinessCentral\Transaction\Order\OrderCommunication
     */
    protected function getInstanweb_Module_Nhbusinesscentral_Transaction_Order_CommunicationService()
    {
        return $this->services['instanweb.module.nhbusinesscentral.transaction.order.communication'] = new \InstanWeb\Module\NHBusinessCentral\Transaction\Order\OrderCommunication(($this->services['instanweb.module.nhbusinesscentral.businesscentralconfiguration.config.data'] ?? $this->getInstanweb_Module_Nhbusinesscentral_Businesscentralconfiguration_Config_DataService()));
    }

    /**
     * Gets the public 'instanweb.module.nhbusinesscentral.transaction.repository' shared service.
     *
     * @return \InstanWeb\Module\NHBusinessCentral\Repository\TransactionRepository
     */
    protected function getInstanweb_Module_Nhbusinesscentral_Transaction_RepositoryService()
    {
        return $this->services['instanweb.module.nhbusinesscentral.transaction.repository'] = new \InstanWeb\Module\NHBusinessCentral\Repository\TransactionRepository(($this->services['doctrine.dbal.default_connection'] ?? $this->getDoctrine_Dbal_DefaultConnectionService()), 'ps_');
    }
    ...
    {
        return $this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('/var/www/html/automotoboutic', '/var/www/html/automotoboutic/modules/');
    }
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/html/automotoboutic/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/html/automotoboutic/var/cache/prod//localization'))));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.root_dir' => '/var/www/html/automotoboutic/app',
            'kernel.project_dir' => '/var/www/html/automotoboutic',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/var/www/html/automotoboutic/var/cache/prod/',
            ...
            'ps_cache_dir' => '/var/www/html/automotoboutic/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/automotoboutic/var/cache/prod//doctrine/orm/Proxies',
