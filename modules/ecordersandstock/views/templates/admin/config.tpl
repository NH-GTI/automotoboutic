...
<div class="panel col-lg-12">
    ...
    <div class="panel col-lg-12" style="background-color: #FFF3CD;">
        <h3>{l s='Exporter les commandes AMB + Marketplace' mod='ecordersandstock'}</h3>
        <div class="col-lg-1">
    ...
    <div class="panel col-lg-12" style="background-color: #CFF4FC;">
        <h3>{l s='Exporter les commandes Contremarque' mod='ecordersandstock'}</h3>
        <div class="col-lg-1">
            <div class="btn btn-default">
...
<div class="panel col-lg-12">
    <div class="panel col-lg-12">
        {l s='Voici le tableau de contôle pour lancer et suivre les tâches planifiées.' mod='ecordersandstock'}
        <br>
