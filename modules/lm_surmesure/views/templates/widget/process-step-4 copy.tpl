					...
					<div class="col-md-4">
						<div class="block_recap_config">
							...
							<ul>
								...
								<li><span>{l s='Finition :' d='Modules.Surmesure.Shop'}</span> {l s='Gamme' d='Modules.Surmesure.Shop'} {$gamme_selected_nom}</li>
								<li>
									...
									<div class="recap_choice_config">
										<div class="row">
											...
											<div class="details_choice_text col-xs-12 col-sm-8 col-md-8">{$conf_selected_desc nofilter}</div>
										</div>
									</div>
								</li>
								<li>
