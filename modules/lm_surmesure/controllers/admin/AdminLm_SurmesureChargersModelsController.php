...
class AdminLm_SurmesureChargersModelsController extends ModuleAdminController
{
    ...
    {
        $this->table = 'telephone_modeles';
        $this->identifier = 'id_modele';
        $this->className = 'LmSurmesureTelephoneModeles';
        $this->lang = false;
        ...
        $this->_join = 'LEFT JOIN `'._DB_PREFIX_.'telephone_marques` m ON (m.`id_marque` = a.`id_marque`)';
        $this->_orderWay= 'ASC';
        $this->_orderBy = 'a.nom';
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                array(
                    ...
                    'name' => 'id_marque',
                    'options' => array(
                        'query' => LmSurmesureTelephoneMarques::getMarques(),
                        'id' => 'id_marque',
                        'name' => 'nom'
                    ),
                    'required' => true,
