...
class AdminLm_SurmesureBachesCategoriesController extends ModuleAdminController
{
    ...
    {
        $this->table = 'baches_categories';
        $this->identifier = 'id_categorie';
        $this->className = 'LmSurmesureBachesCategories';
        $this->lang = false;
		...
		$this->fields_list = array(
			'id_categorie' => array(
				...
				'align' => 'text-center',
				'filter_key' => 'a!id_categorie',
				'class' => 'fixed-width-xs'
			),
			'nom' => array(
				'title' => $this->trans('Catégorie', array(), 'Modules.Surmesure.Admin'),
				'align' => 'text-left',
				'filter_key' => 'a!nom',
			),
		);
