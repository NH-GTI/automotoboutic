 ...
 * Init
 */
const exportCustomerMappingTab = ExportCustomersTabbar.tabs('mapping');
const exportCustomerMappingTab_layout = exportCustomerMappingTab.attachLayout("2U");

/**
 * Mapping list
 */
const exportCustomerMappingTab_list = exportCustomerMappingTab_layout.cells('a');
exportCustomerMappingTab_list.setText('<?php echo _l('Template list', true); ?>');
exportCustomerMappingTab_list.setWidth(400);

const exportCustomerMappingTab_list_toolbar = exportCustomerMappingTab_list.attachToolbar();
 ...
 * Mapping form
 */
const exportCustomerMappingTab_configuration_layout = exportCustomerMappingTab_layout.cells('b');
...
const exportCustomerMappingTab_configuration = {};
...
exportCustomerMappingTab_configuration._selected_fields_grid.setImagePath("lib/js/imgs/");
