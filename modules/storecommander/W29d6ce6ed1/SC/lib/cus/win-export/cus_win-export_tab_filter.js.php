 ...
 * Init
 */
const exportCustomerFilterTab = ExportCustomersTabbar.tabs('filter');
const exportCustomerFilterTab_layout = exportCustomerFilterTab.attachLayout("2U");

/**
 * Filter list
 */
const exportCustomerFilterTab_list = exportCustomerFilterTab_layout.cells('a');
exportCustomerFilterTab_list.setText('<?php echo _l('Filter list', true); ?>');
exportCustomerFilterTab_list.setWidth(350);

const exportCustomerFilterTab_list_toolbar = exportCustomerFilterTab_list.attachToolbar();
 ...
 * Filter form
 */
const exportCustomerFilterTab_configuration_layout = exportCustomerFilterTab_layout.cells('b');
