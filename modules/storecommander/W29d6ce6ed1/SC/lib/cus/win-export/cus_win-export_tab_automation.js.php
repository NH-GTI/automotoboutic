 ...
 * Init
 */
const exportCustomerAutomationTab = ExportCustomersTabbar.tabs('cron');
const exportCustomerAutomationTab_layout = exportCustomerAutomationTab.attachLayout("1C");
const exportCustomerAutomationTab_list = exportCustomerAutomationTab_layout.cells('a');
exportCustomerAutomationTab_list.setText('<?php echo _l('List', true); ?>');

const exportCustomerAutomationTab_list_toolbar = exportCustomerAutomationTab_list.attachToolbar();
...
const exportCustomerCron_grid = exportCustomerAutomationTab_list.attachGrid();
