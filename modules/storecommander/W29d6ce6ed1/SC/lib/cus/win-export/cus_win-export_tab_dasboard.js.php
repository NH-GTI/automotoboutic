 ...
 * Init
 */
const exportCustomerDashboardTab = ExportCustomersTabbar.tabs('dashboard');
const exportCustomerDashboardTab_layout = exportCustomerDashboardTab.attachLayout("3W");
 ...
 * Export list
 */
const exportCustomerDashboardExportList = exportCustomerDashboardTab_layout.cells('a');
...
const exportCustomerDashboardExportList_toolbar = exportCustomerDashboardExportList.attachToolbar();
 ...
 * Export preview
 */
const exportCustomerDashboardPreview = exportCustomerDashboardTab_layout.cells('b');
...
const exportCustomerDashboardPreview_statusbar = exportCustomerDashboardPreview.attachStatusBar();
exportCustomerDashboardPreview_statusbar.setText('0 <?php echo _l('order'); ?>');
...
const exportCustomerDashboardPreview_grid = exportCustomerDashboardPreview.attachGrid();
...
exportCustomerDashboardPreview_grid._displayGrid = function () {
    ...
    $.post('index.php?ajax=1&act=cus_win-export_preview_get', {
        ...
        exportCustomerDashboardPreview_statusbar.setText(nb + (nb > 1 ? " <?php echo _l('customers'); ?>" : " <?php echo _l('order'); ?>"));
    });
};
 ...
 * Export Results
 */
const exportCustomerDashboardExport_result = exportCustomerDashboardTab_layout.cells('c');
