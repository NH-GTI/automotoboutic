...
require_once dirname(__FILE__).'/all_win-gridseditor_tools.php';
    ...
    // FIELDS GROUPS
        ...
        if ($type == 'products')
        {
            ...
            $group_fields[$name] = array(
                    'name' => 'gp_reductions:margin+margin_after_reduction+margin_wt_percent_after_reduction+margin_wt_amount_after_reduction+price+id_tax_rules_group+price_inc_tax+ecotax+wholesale_price+reduction_price+price_with_reduction+reduction_percent+price_with_reduction_percent+reduction_from+reduction_to+price_wt_with_reduction+price_it_with_reduction',
                    'text' => $name,
                    'celltype' => '',
                    'align' => '',
                    'sort' => '',
