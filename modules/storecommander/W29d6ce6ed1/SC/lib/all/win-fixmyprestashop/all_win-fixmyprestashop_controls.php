...
$controls['CAT_PRODUCT_IMG_WITHOUT_LEGEND'] = array(
...
$controls['CAT_PRODUCT_PRICE_TOO_LOW'] = array(
...
{
    $controls['SEC_MODULE_SCFIXMYPRESTASHOP'] = array(
        'key' => 'SEC_MODULE_SCFIXMYPRESTASHOP',
        'version_min' => '',
        'version_max' => '',
        'tools' => 'Security',
        'section' => 'Modules',
        'name' => array('Check module %s', array(_l('Fix My Prestashop'))),
        'description' => array('Verify if the module version of %s is up to date', array(_l('Fix My Prestashop'))),
    );
}
