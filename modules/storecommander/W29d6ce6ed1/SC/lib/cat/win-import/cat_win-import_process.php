...
//                                 $default, $location = null, $upc = null, $minimal_quantity = 1, array $id_shop_list = array())
            ...
            {
                echo _l('Some lines of your CSV file have been ignored for one the reasons explained in this article')._l(':');
                echo '<a href="'.getScExternalLink('support_csv_import_ignored_lines').'" target="_blank">'.getScExternalLink('support_csv_import_ignored_lines').'</a>';
                echo '<br/><br/>';
