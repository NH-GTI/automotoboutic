...
$colSettings['price_with_reduction_tax_excl'] = array('text' => _l('Price tax excl after reduction'), 'width' => 65, 'align' => 'left', 'type' => 'edn', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter', 'format' => (_s('CAT_PROD_PRICEWITHOUTTAX4DEC') ? '0.0000' : '0.00'));
$colSettings['price_with_reduction_tax_incl'] = array('text' => _l('Price tax incl after reduction'), 'width' => 65, 'align' => 'left', 'type' => 'edn', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter', 'format' => (_s('CAT_PROD_PRICEWITHTAX4DEC') ? '0.0000' : '0.00'));
...
$colSettings['price_exl_tax'] = array('text' => _l('Price excl. Tax'), 'width' => 65, 'align' => 'right', 'type' => 'ron', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter', 'format' => (_s('CAT_PROD_PRICEWITHOUTTAX4DEC') ? '0.0000' : '0.00'));
$colSettings['price_inc_tax'] = array('text' => _l('Price incl. Tax'), 'width' => 65, 'align' => 'right', 'type' => 'ron', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter', 'format' => (_s('CAT_PROD_PRICEWITHTAX4DEC') ? '0.0000' : '0.00'));
