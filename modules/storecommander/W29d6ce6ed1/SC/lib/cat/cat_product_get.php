...
*/
    ...
    */
    ...
    function getProducts($id_category, $segment_params = array())
    {
        ...
        $cache_amazon_present = $cache_cdiscount_present = $cache_feedbiz_present = $cache_feedbiz_amazon_present = $cache_feedbiz_cdiscount_present = array();
        if (!empty($res) && _s('APP_FEEDBIZ') && defined('SC_FeedBiz_ACTIVE') && SC_FeedBiz_ACTIVE == 1 && SCI::moduleIsInstalled('feedbiz'))
        {
        ...
        if (!empty($res) && _s('APP_AMAZON') && defined('SC_Amazon_ACTIVE') && SC_Amazon_ACTIVE == 1 && SCI::moduleIsInstalled('amazon'))
        {
        ...
        if (!empty($res) && _s('APP_CDISCOUNT') && defined('SC_Cdiscount_ACTIVE') && SC_Cdiscount_ACTIVE == 1 && SCI::moduleIsInstalled('cdiscount'))
        {
            $id_product_list = array();
            foreach ($res as $r)
            {
