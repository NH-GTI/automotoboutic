 ...
 * Init
 */
const exportOrderFilterTab = exportOrdersTabbar.tabs('filter');
const exportOrderFilterTab_layout = exportOrderFilterTab.attachLayout("2U");

/**
 * Filter list
 */
const exportOrderFilterTab_list = exportOrderFilterTab_layout.cells('a');
exportOrderFilterTab_list.setText('<?php echo _l('Filter list', true); ?>');
exportOrderFilterTab_list.setWidth(350);

const exportOrderFilterTab_list_toolbar = exportOrderFilterTab_list.attachToolbar();
 ...
 * Filter form
 */
const exportOrderFilterTab_configuration_layout = exportOrderFilterTab_layout.cells('b');
