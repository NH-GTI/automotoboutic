 ...
 * Init
 */
const exportOrderDashboardTab = exportOrdersTabbar.tabs('dashboard');
const exportOrderDashboardTab_layout = exportOrderDashboardTab.attachLayout("3W");
 ...
 * Export list
 */
const exportOrderDashboardExportList = exportOrderDashboardTab_layout.cells('a');
...
const exportOrderDashboardExportList_toolbar = exportOrderDashboardExportList.attachToolbar();
 ...
 * Export preview
 */
const exportOrderDashboardPreview = exportOrderDashboardTab_layout.cells('b');
exportOrderDashboardPreview.setText('<?php echo _l('Overview limited to %s results', true,array(ExportOrderFilter::$preview_limit)); ?>');
const exportOrderDashboardPreview_statusbar = exportOrderDashboardPreview.attachStatusBar();
...
const exportOrderDashboardPreview_grid = exportOrderDashboardPreview.attachGrid();
 ...
 * Export Results
 */
const exportOrderDashboardExport_result = exportOrderDashboardTab_layout.cells('c');
