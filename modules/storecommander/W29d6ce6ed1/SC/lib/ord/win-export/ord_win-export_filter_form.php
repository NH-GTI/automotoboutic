...
{ ?>
            ...
            $.widget('prestashop.scQuickAccountingAutocomplete', $.ui.autocomplete, {
            ...
            $("#scproduct_search_query").scQuickAccountingAutocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $('#scproduct_search_query').val(ui.item.name);
                    $('#scproduct_search_id_to_add').val(ui.item.id);
                    $('#scproduct_search_name_to_add').val(ui.item.name);
                },
            });

<?php
}
elseif (isset($isPS17) && $isPS17)
{
?>
...
?>
            ...
            // define the autocompletion behavior on the filter on product search

            $("#scproduct_search_query")
                ...
                .result(function (event, data, formatted) {
                    ...
                    // display the product complete name

                    $('#scproduct_search_query').val(data.pname);

                    // update the add product link with the product id / name

                    $('#scproduct_search_id_to_add').val(data.id_product);

                    $('#scproduct_search_name_to_add').val(data.pname);
