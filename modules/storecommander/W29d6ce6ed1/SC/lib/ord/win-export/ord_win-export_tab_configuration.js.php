 ...
 * Init
 */
const exportOrderConfigurationTab = exportOrdersTabbar.tabs('configuration');
const exportOrderConfigurationTab_layout = exportOrderConfigurationTab.attachLayout("1C");
const exportOrderConfigurationTab_configuration_layout = exportOrderConfigurationTab_layout.cells('a');
exportOrderConfigurationTab_configuration_layout.hideHeader();
/**
 * toolbar
 */
const exportOrderConfigurationTab_form_toolbar = exportOrderConfigurationTab_configuration_layout.attachToolbar();
 ...
 * form
 */
const exportOrderConfigurationTab_form = {};
