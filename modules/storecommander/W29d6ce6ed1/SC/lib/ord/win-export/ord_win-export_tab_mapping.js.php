 ...
 * Init
 */
const exportOrderMappingTab = exportOrdersTabbar.tabs('mapping');
const exportOrderMappingTab_layout = exportOrderMappingTab.attachLayout("2U");

/**
 * Mapping list
 */
const exportOrderMappingTab_list = exportOrderMappingTab_layout.cells('a');
exportOrderMappingTab_list.setText('<?php echo _l('Template list', true); ?>');
exportOrderMappingTab_list.setWidth(400);

const exportOrderMappingTab_list_toolbar = exportOrderMappingTab_list.attachToolbar();
 ...
 * Mapping form
 */
const exportOrderMappingTab_configuration_layout = exportOrderMappingTab_layout.cells('b');
...
const exportOrderMappingTab_configuration = {};
...
exportOrderMappingTab_configuration._selected_fields_grid.setImagePath("lib/js/imgs/");
