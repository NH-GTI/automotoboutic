 ...
 * Init
 */
const exportOrderAutomationTab = exportOrdersTabbar.tabs('cron');
const exportOrderAutomationTab_layout = exportOrderAutomationTab.attachLayout("1C");
const exportOrderAutomationTab_list = exportOrderAutomationTab_layout.cells('a');
exportOrderAutomationTab_list.setText('<?php echo _l('List', true); ?>');

const exportOrderAutomationTab_list_toolbar = exportOrderAutomationTab_list.attachToolbar();
...
const exportOrderCron_grid = exportOrderAutomationTab_list.attachGrid();
