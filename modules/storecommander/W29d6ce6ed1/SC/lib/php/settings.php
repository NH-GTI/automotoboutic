...
$default_settings = array(
    ...
    'APP_AMAZON' => array('id' => 'APP_AMAZON', 'section1' => 'Application', 'section2' => 'Interface', 'default_value' => '0', 'name' => ' Amazon', 'description' => 'Possible values:<br/>1: Activate<br/>0: Deactivate'),
    'APP_CDISCOUNT' => array('id' => 'APP_CDISCOUNT', 'section1' => 'Application', 'section2' => 'Interface', 'default_value' => '0', 'name' => 'Cdiscount', 'description' => 'Possible values:<br/>1: Activate<br/>0: Deactivate'),
    'APP_FEEDBIZ' => array('id' => 'APP_FEEDBIZ', 'section1' => 'Application', 'section2' => 'Interface', 'default_value' => '0', 'name' => 'FeedBiz', 'description' => 'Possible values:<br/>1: Activate<br/>0: Deactivate'),
    'ORD_EXPORT_CSV' => array('id' => 'ORD_EXPORT_CSV', 'section1' => 'Orders', 'section2' => 'Export', 'default_value' => '0', 'name' => 'Display config. (expert) tab', 'description' => 'Possible values:<br/>0: No<br/>1: Yes'),
);
 ## Creative Elements
