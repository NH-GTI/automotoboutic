            ...
            if (!isTable(SC_DB_PREFIX.'extension_export_order_filter'))
            {
                ...
                if(Db::getInstance()->execute($query))
                {
                    ...
                    else
                    {
                        ...
                        Db::getInstance()->execute("INSERT INTO `" . _DB_PREFIX_ . SC_DB_PREFIX . "extension_export_order_filter` (`id_order_filter`, `name`, `description`, `dynamic_definition`, `date_add`, `date_upd`)
