...
//						'Order_Detail_Product_Location'=>array('sqlField'=>'odp.`location`', 'fieldType'=>'orderDetailProduct', 'translations'=>array(1=>'Order detail - product location',2=>'Détail commande - Emplacement (entrepôt) produit')),
        ...
        $fieldsInfos['Order_Total_Taxes'] = array('sqlField' => ' (SELECT (oi.total_paid_tax_incl - oi.total_paid_tax_excl) FROM `'._DB_PREFIX_.'order_invoice` oi WHERE oi.`id_order` = o.`id_order`) ', 'fieldType' => 'order', 'translations' => array(1 => 'Total taxes', 2 => 'Total taxes'), 'total' => 'order', 'price' => 1);
