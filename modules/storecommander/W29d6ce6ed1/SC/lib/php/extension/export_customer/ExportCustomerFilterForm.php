...
class ExportCustomerFilterForm
{
     ...
     * @return string
     */
    public function displayFieldRule($ruleName, $displayName, $ruleDescriptors, $fieldType, $choiceText1 = null, $choiceText2 = null, $editedList = null)
    {
        $html = '';
        ...
        switch ($fieldType) {
            case 'boolean':
                $html = $this->displayBooleanRule($ruleName, $displayName, $rule, $choiceText1, $choiceText2);
                break;
            case 'string':
            ...
            case 'date':
                ...
                break;
            case 'gender':
                $html = $this->displayGenderRule($ruleName, $displayName, $rule);
                break;
            case 'number':
            ...
            case 'pdt_category':
                ...
                break;
            case 'other_list':
                $html = $this->displayOtherListRule($ruleName, $displayName, $rule, $editedList);
                break;
            case 'lang':
                $html = $this->displayLangRule($ruleName, $displayName, $rule);
                break;
            default:
                ExportCustomerTools::addLog('CList edit : unable to display rule ' . $ruleName . ' with type ' . $fieldType);
                return '';
        }
        return $html;
    }
