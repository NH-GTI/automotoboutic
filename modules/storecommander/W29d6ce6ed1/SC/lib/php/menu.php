...
<?php
    if(_r('MENU_ORD_EXPORTORDERS'))
    {
        ...
        {
            ?>
            '<item id="acc_quickaccounting" text="<?php echo _l('CSV Export', 1); ?>" img="fad fa-sign-out fa-flip-horizontal green" imgdis="fad fa-sign-out fa-flip-horizontal green"></item>'+
            <?php
        }
        else
        {
...
'<item id="customer" text="<?php echo _l('Customers', 1); ?>" img="fa fa-user" imgdis="fa fa-user">'+
    ...
    if (_r('MENU_CUS_EXPORTCUSTOMERS'))
    {
        ...
        {    ?>
        '<item id="cus_export" text="<?php echo _l('CSV Export', 1); ?>" img="fad fa-sign-out fa-flip-horizontal green" imgdis="fad fa-sign-out fa-flip-horizontal green"/>'+
    <?php
        }
        else
        { ?>
...
?>
    ...
    <?php } ?>
    '<item id="all_settings" text="<?php echo _l('Settings', 1); ?>" img="fad fa-sliders-v-square yellow" imgdis="fad fa-sliders-v-square yellow">'+
        ...
        <?php if (_r('MEN_TOO_LANGUAGE')) { ?>
            '<item id="core_language" text="<?php echo _l('Interface language', 1); ?>" img="fad fa-flag blue" imgdis="fad fa-flag blue">'+
    ...
    '</item>'+
    '<item id="security" text="<?php echo _l('Security', 1); ?>" img="fas fa-lock-alt" imgdis="fas fa-lock-alt">'+
        <?php if (_r('MEN_TOO_PERMISSIONS')) { ?>
            '<item id="permissions" text="<?php echo _l('User permissions', 1); ?>" img="fad fa-user-shield green" imgdis="fad fa-user-shield green"/>'+
        <?php } ?>
            '<item id="early_access" text="<?php echo _l('Early access', 1); ?>" img="fad fa-regular fa-flask" imgdis="fad fa-regular fa-flask"/>'+
    '</item>'+
