<?php $LANG =array (
  ...
  'Date add' => 'Date add',
  'Date update' => 'Last modified date',
  ...
  'Patched' => '',
  'Products selection' => '',
  'Existing Prestashop products will not be overridden' => '',
  'All imported products from Shippingbo' => '',
  'selected product(s)' => '',
  'No product selected' => '',
  'Pending products' => '',
  ...
  'Invoice address' => '',
  'Calculated fields' => '',
  'Settings to be modify only if your export includes a VAT breakdown and exported rate values are incorrect (ex. 20,1 or 19,99)' => '',
  'It is not recommended to changes these settings.' => '',
  'Regenerate a new security key for selected rows' => '',
  'File %s deleted' => '',
  'Interface language' => '',
  'Share' => '',
  'Without orders' => '',
  ...
  'Order total amount' => '',
  'Subscription date' => '',
  'To apply a filter on orders amount or number, you should also select the order states to include.' => '',
  'To apply a filter on orders products/category, you should also select the order states to include.' => '',
  'No product has been selected for filter.' => '',
  'No category has been selected for filter.' => '',
  'will include in list all customers and then, filter them by some properties you will define' => '',
  'Filter on customers properties' => '',
  'Filter on customers address properties' => '',
  'Filter on customers orders properties' => '',
  'Filter with other Customers Lists' => '',
  'Filter on Newsletters subscribers properties' => '',
  'Warning : if you choose some order fields in export model, you must select order status in filters.' => '',
  'Not in' => '',
  'No other list to display' => '',
  'Uncheck all' => '',
  'Check all' => '',
  'Show/hide the categories' => '',
  'Have NOT subscribed' => '',
  'NOT ok to receive offers' => '',
  'Not deleted' => '',
  'Register date' => '',
  'With orders' => '',
  'Orders date' => '',
  ...
  'Group name' => '',
  'Third-party offers' => '',
  'ok to receive offers' => '',
  'Active account' => '',
  'Deleted account' => '',
  'Deleted' => '',
  'Have subscribed' => '',
  'In the list (separated by a ",")' => '',
  'Customer fields' => '',
  'Address fields' => '',
  'Order fields' => '',
  'Miscellaneous fields' => '',
  'Warning : if you choose some order fields, you must select order status in customer list filters.' => '',
  'The %s module in your back office is now integrated into %s via the "%s" menu.' => '',
  'Click to download a backup of the current module' => '',
  'Click to delete the module' => '',
  'If you ordered a module modification please contact us at <br>%s or by %s<br>before uninstalling and deleting the module' => '',
  'Modify fixed specific prices, ex%s %s' => '',
  'Generate' => '',
  'e-Cards' => '',
  'Occurences found' => '',
  'Customer Export Pro' => '',
  ...
  'Filter list' => '',
  'Overview limited to %s results' => '',
  'Template %s updated' => '',
  'Unable to update template %s' => '',
  'New template added' => '',
  'Unable to add template' => '',
  'invalid template' => '',
  'Template %s deleted' => '',
  'Unable to delete template' => '',
  'Template is used for export IDs' => '',
  'No data corresponding to the selected filter' => '',
  ...
  'Import Shippingbo data to Prestashop' => '',
  'last update' => '',
  'Shippingbo data' => '',
  'This product can not be a %s because it contains combinations' => '',
  'This product has no %s.' => '',
  'matching' => '',
  'missing' => '',
  'View missing %s in Shippingbo' => '',
  'View missing %s in Prestashop' => '',
  'Download missing %s' => '',
  'Shippingbo import ready !' => '',
  'How to use ?' => '',
  'Collect Shippingbo data' => '',
  'only updates' => '',
  'full data (longer)' => '',
  'Product ISBN' => '',
  'default CMS properties panel' => '',
  'Set CMS properties panel displayed when you launch SC. (seo, description)' => '',
  'default manufacturer properties panel' => '',
  'Set manufacturer properties panel displayed when you launch SC. (seo, description)' => '',
  'default manufacturer grid view' => '',
  'Set manufacturer grid view displayed when you launch SC. (grid_light, grid_large, grid_seo)' => '',
  'default supplier properties panel' => '',
  'Set supplier properties panel displayed when you launch SC. (seo, description)' => '',
  'default supplier grid view' => '',
  'Set supplier grid view displayed when you launch SC. (grid_light, grid_large, grid_seo)' => '',
  'new supplier active state default' => '',
  'Active state used when the supplier is created in SC. The active column must be present in the grid.' => '',
  'Set CMS grid view displayed when you launch SC. (grid_light, grid_large, grid_seo)' => '',
  'max supplier to open in browser' => '',
  'Set the maximum number of new browser tabs to open when you do a right click on supplier > See on shop' => '',
  'This field cannot be modified because it is an Advanced Pack product.' => '',
  'Check product images without legend' => '',
  'List of product images with legend empty or null' => '',
  'Image without legend' => '',
  'Products with price too low' => '',
  'List of products for which the wholesale price is higher than the price excluding tax' => '',
  'Negative margin' => '',
  'additional reference' => '',
  'combinations only' => '',
  'Contact me in' => '',
  'Import Shippingbo data' => '',
  'Restart synchronization' => '',
  'Analyzing Shippingbo data' => '',
  'Updating Shippingbo data' => '',
  'Matching Prestashop data' => '',
  'Refreshing stats' => '',
  'Clear buffer tables' => '',
  'Clear relation table' => '',
  'Clear Shippingbo settings' => '',
  'Actions in this panel may cause data loss, please use it only if you know what you\'re doing' => '',
  'Imports' => '',
  'Exports' => '',
  'Import parameters' => '',
  'Export parrameters' => '',
  'Api parameters' => '',
  'Export parameters' => '',
  'missing products in %s' => '',
  'missing batches in %s' => '',
  'missing packs in %s' => '',
  'first start' => '',
  'Enable Shippingbo Synchronization for selection' => '',
  'Disable Shippingbo Synchronization for selection' => '',
  'completed' => '',
  'go to dashboard' => '',
  'Remove Shippingbo Segmentation and all containing products' => '',
  'Address updated' => '',
  'Filter %s duplicated' => '',
  'Unable to duplicate filter' => '',
  'Duplicate selected filter' => '',
  'Duplicate selected template' => '',
  'Unable to duplicate template' => '',
  'Template %s duplicated' => '',
  'id_product cannot be the identifier for product creation.' => '',
  'add to selection' => '',
  'create combinations' => '',
  '%s is empty' => '',
  'convert to combinations' => '',
  'open in Shippingbo' => '',
  'New parent product for these combinations' => '',
  'The new product will be used to link new combinations, for instance a product named "T-shirt" will have combinations like \'Size:XL/Color:Blue\',\'Size:XL/Color:Red\',etc. ' => '',
  'combinations to create' => '',
  'combination reference' => '',
  'You must add at least one attribute group to create combination(s)' => '',
  'You must fill all combinations values' => '',
  'close window' => '',
  'combinations successfully created' => '',
  'this product is not a %s' => '',
  'This product can not be a %s and must be managed in Shippingbo' => '',
  'This product must be managed in Shippingbo' => '',
  'This %s must be managed in Shippingbo' => '',
  'Some lines of your CSV file have been ignored for one the reasons explained in this article' => '',
  'Product is missing, please try first to import missing products file to Shippingbo' => '',
  'Expert' => '',
  'In Shippingbo, not in Prestashop' => '',
  'In Prestashop, not in  Shippingbo' => '',
  'packs' => '',
  ...
  'Your file contains line breaks. Apply this check' => '',
  'Unable to import this pack, because it has no pack component in Shippingbo' => '',
  'Orders with products specific attribute ...' => '',
  'Selectable option' => '',
  'Check options before export' => '',
  'Set options when loading mapping' => '',
  'If enabled: display active products only' => '',
  'Are you sure you want to create {nb} combinations ?' => '',
  'SKU is too long, %s characters max' => '',
  'You can\'t archive a permanent project' => '',
  'These products won\'t be converted because the type associated is not supported for this operation' => '',
  'not imported products in %s' => '',
  'not imported packs in %s' => '',
  'not imported batches in %s' => '',
  'Last update of the dashboard' => '',
  'Locked' => '',
  'Reference is required' => '',
  'Reference is duplicated' => '',
  'The product composing this %s doesn\'t exists in Shippingbo' => '',
  'SKU is too long, Prestashop limit is %s characters' => '',
  'View %s' => '',
  'Import into Prestashop' => '',
  'Go to Shippingbo' => '',
  'Download %s' => '',
  'Click on the button at the bottom of the page to update the data' => '',
  'There is no 4th column for this property' => '',
  'Invalid filename' => '',
  'view products' => '',
  'view batches' => '',
  'view packs' => '',
  ...
  'download packs' => '',
  '%s with error' => '',
  '%s with synchronisation disabled' => '',
  'awaiting import' => '',
  'download pack components' => '',
  'Configure Shippingbo Access' => '',
  'Shippingbo import preferences' => '',
  'Shippingbo export preferences' => '',
  'let\'s go' => '',
  'Some products may be excluded from Shippingbo synchronisation.' => '',
  ...
  'rows per page' => '',
  'No Records Found' => '',
  'Some %s may be excluded from Shippingbo synchronisation.' => '',
  'View list' => '',
  'Allow to automatically close open sub-categories when changing parent category' => '',
  'Authentication problem: please check <a href="%s">Shippingbo connection settings</a> If the problem persists, please contact the Shippingbo team.' => '',
  'Update data by importing files into <a href="#" class="%s">Shippingbo</a>' => '',
  '%s awaiting import' => '',
  'hide this panel' => '',
  'logistic' => '',
  'Shippingbo synchronization' => '',
  'Open selected %s in Shippingbo' => '',
  'Customize' => '',
  ...
  'of control' => '',
  'Products with a short description of less, more or equal to X characters' => '',
  'Products with a description of less, more or equal to X characters' => '',
  'Products without meta title and or meta description' => '',
  'Products with duplicate meta title and or meta description' => '',
  'The template <b>%s</b> contains at least one order field.<br>You must include order states in the <b>%s</b> filter' => '',
  'Nb characters' => '',
  'Model' => '',
  'ID Product' => '',
  'Unit conversion' => '',
  ...
  'Hide column Year' => '',
  'Show column Year' => '',
  'Shippingbo shop(s) preferences' => '',
  'Successful configuration of the Shippingbo/Prestashop connector' => '',
  'To configure Shippingbo service, go to e-services > Shippingbo management' => '',
  'The year must be 4 digits.' => '',
  'The year must be an integer.' => '',
  'association already exist' => '',
  'Display columns and the property related to EveryParts' => '',
  'Validate duplicated lines' => '',
  'Cancel duplication' => '',
  'Modification OK.' => '',
  'Open in EveryParts panel' => '',
  'Add compatibility' => '',
  'Tips : you can insert compatibilities from another product here with right click.' => '',
  'You can leave blank or enter a year YYYY or a period YYYY-YYYY' => '',
  'Period too long (40 years max) !' => '',
  'Year stats order' => '',
  'Possible values:<br/>0: Ascending order (standard)<br/>1: Descending order' => '',
  'Duplicate a compatibility line' => '',
  'Products with images without legend (alt tag)' => '',
  'Everywhere' => '',
  'Catalog only' => '',
  'Search only' => '',
  'Nowhere' => '',
  'ID ghost parent' => '',
  'Open the selected product in EveryParts' => '',
  'You have to select the type, the manufacturer AND the model to insert compatibilities !' => '',
  'Your file contains line breaks' => '',
  'PS: image format %s has one or two wrong dimensions. Height:%s Width:%s' => '',
  'Delete log (errors and system alerts), parameter is used to keep the specified number of logs in the table' => '',
  'Contact us' => '',
  'There are compatibility lines waiting to be inserted. If you continue, they will be lost. Continue?' => '',
  'No result' => '',
  'shop ready' => '',
  'shop not ready' => '',
  'Configure connection' => '',
  'product not found' => '',
  'Please use the sync button and redo your action !' => '',
  'awaiting export' => '',
  'Shippingbo export ready !' => '',
  '%s awaiting export' => '',
  '%s with synchronisation enabled' => '',
  '2 days' => '',
  'Today' => '',
  'Complete configuration' => '',
  'Export settings' => '',
  '%s access API configuration' => '',
  'Model active' => '',
  'This product does not exist in EveryParts' => '',
  ...
  'Shippingbo connector is not compatbile with AdvancedPack module!' => 'Shippingbo connector is not compatible with AdvancedPack module!',
  'Shippingbo access' => '',
  'Shop configuration' => '',
  'Shop selection' => '',
  ...
  'You have a new version to install' => '',
  'We strongly recommend that you enable automatic updates.' => '',
  'Enable automatic updates' => '',
  'I accept' => '',
  'Terms & Conditions' => '',
  'Error while activating the automatic update' => '',
  'Error while disabling the automatic update' => '',
  'Window will be reloaded in %s seconds' => '',
  '%s is up to date. Installed version: %s' => '',
  'An error occurend' => '',
  'Autoupdate successfully enabled' => '',
  'Autoupdate successfully disabled' => '',
  'You can not create a category here' => '',
  'Authentication problem: please check Shippingbo connection settings.<br/> If the problem persists, please contact the Shippingbo team.' => '',
  'Update in progress' => '',
  'Application will restart automatically at the end of the update' => '',
  'Download packs' => '',
  'Download batches' => '',
  'Download products' => '',
  'Analyze Shippingbo data' => '',
  'No preview to display' => '',
  'Synchronize products to EveryParts' => '',
  'Folder' => '',
  'synchronized' => '',
  'Several products/combinations share this same reference in Prestashop' => '',
  'Several products/combinations use the same reference in Prestashop' => '',
  'Are you sure you want to synchronize selected product(s) towards EveryParts ?' => '',
  'Selected product(s) was synchronized to EveryParts' => '',
  'Are you sure you want to scrap the Shippingbo link?' => '',
  'Are you sure you want to scrap the Shippingbo links?' => '',
  'remove Shippingbo link' => '',
  'All information relating to the connector will be deleted from the database' => '',
  'Reset the connector' => '',
  'All the connector information will be removed from the database' => '',
  'Shippingbo connector' => '',
  'Check my catalogue before starting' => '',
  'Enable Shippingbo synchronization' => '',
  'awaiting' => '',
  'Duplicated categories' => '',
  'Categories with same name and same parent category' => '',
  'Nb. products' => '',
  'Category updated' => '',
  'Error updating category' => '',
  '%s is required in multistore mode while having "%s" configuted in mapping' => '',
  'Setting updated' => '',
  'Setting updated. You need to refresh the page.' => '',
  'Consider a fixed price (special price) as a promotion in line colouring' => '',
);