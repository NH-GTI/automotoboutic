...
if (!defined('STORE_COMMANDER')) { exit; }
    ...
    function displayCustomerOrders()
    {
        ...
        $.post('index.php?ajax=1&act=cus_orders_get',
        {
            id_lang: SC_ID_LANG,
    ...
    {
        prop_tb._customerProductGrid.clearAll(true);
        $.post('index.php?ajax=1&act=cus_orders_products_get',
        {
            id_lang: SC_ID_LANG,
            id_order_list: castListId(prop_tb._customerOrderGrid.getSelectedRowId())
        }, function(data)
        {
