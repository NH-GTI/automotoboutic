...
if (_r('GRI_CUS_PROPERTIES_GRID_NOTES'))
{
    $subprop_name = 'notes';
    ...
    function setPropertiesPanel_Notes(id){
        ...
        if (id=='notes_save')
        {
            ...
            $.post('index.php?ajax=1&act=cus_notes_update',{id_customer:Number(lastCustomerSelID),content:note_content},function(data)
            {
                if(data == 'OK') {
    ...
    {
        $.post('index.php?ajax=1&act=cus_notes_get',
            {
