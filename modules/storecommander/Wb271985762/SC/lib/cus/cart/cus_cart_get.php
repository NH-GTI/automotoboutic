...
$id_customer = (string) Tools::getValue('id_customer_list', null);
                    ...
                    foreach ($cols as $col)
                    {
                        switch ($col) {
                            case 'id_cart':
                                ...
                                break;
                            case 'shop_name':
                                $xml .= '<cell>'.Shop::getShop((int) $cart_obj->id_shop)['name'].'</cell>';
                                break;
                            case 'id_customer':
                            ...
                            case 'stock_available':
                                $xml .= '<cell><![CDATA['.SCI::getProductQty($product['id_product'], $product['id_product_attribute'], null, (!empty($cart_obj->id_shop) ? $cart_obj->id_shop : null)).']]></cell>';
                                break;
                            default:
