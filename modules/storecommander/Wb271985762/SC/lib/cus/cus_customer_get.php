...
if (!defined('STORE_COMMANDER'))
{
    ...
    function getCustomers($segment_object = null)
    {
        ...
        $fields_customer = ['id_shop', 'id_customer', 'id_gender', 'firstname', 'lastname', 'email', 'active', 'newsletter', 'optin', 'date_add', 'birthday', 'id_default_group', 'note'];
        if (version_compare(_PS_VERSION_, '1.5.0.0', '>='))
        {
        ...
        {
            $fields_address = ['id_address', 'alias', 'id_customer', 'company', 'lastname', 'firstname', 'address1', 'address2', 'postcode', 'city', 'id_state', 'id_country', 'other', 'phone', 'phone_mobile', 'dni', 'vat_number'];
            ...
            if (!empty($id_segment) && SCSG)
            {
                ...
                {
                    $params = ['id_lang' => $id_lang, 'id_segment' => $id_segment, 'access' => 'customers'];
                    for ($i = 1; $i <= 15; ++$i)
                    {
            ...
            if (!empty($filter_params))
            {
                ...
                foreach ($filters as $filter)
                {
                    ...
                    {
                        if (sc_in_array($field, ['id_customer', 'id_order'], 'cusGet_searchfields'))
                        {
        ...
        else
        {
            sc_ext::readCustomCustomersGridsConfigXML('updateSettings');
            $blacklistfields = [];
            $sqlCustomer = ['c.`id_customer`', 'c.`id_shop`'];
