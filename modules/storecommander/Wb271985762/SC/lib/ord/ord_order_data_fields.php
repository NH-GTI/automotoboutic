...
$colSettings['inv_dni'] = array('text' => _l('DNI'), 'width' => 70, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
...
{
    $colSettings['is_pack'] = array('text' => _l('Pack'), 'width' => 45, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array(0 => _l('No'), 1 => _l('Yes')));
}
$colSettings['location'] = array('text' => _l('Stock location'), 'width' => 70, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter', 'onlyforgrids' => array('grid_picking'));
