...
$id_product = Tools::getValue('id_product_id_product_attribute');
...
function getRowsFromDB()
{
    ...
    $sql = 'SELECT p.id_product,p.id_category_default,pl.name as p_name,pa.id_product_attribute, p.ean13, p.reference,
            ...
            '.(version_compare(_PS_VERSION_, '1.5.0.10', '>=') ? ' ,ps.id_shop,ps.id_category_default,pas.default_on,ps.price, ps.id_tax_rules_group, ps.ecotax,pas.price AS pa_price, pas.ecotax AS pa_ecotax,ps.active' : 'p.active').'
