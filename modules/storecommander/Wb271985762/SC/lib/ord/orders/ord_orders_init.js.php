...
if (_r('GRI_ORD_PROPERTIES_GRID_ORDERS')) { ?>
    ...
    function displayOrderOrders()
    {
        ...
        $.post("index.php?ajax=1&act=ord_orders_get&id_lang="+SC_ID_LANG, {id_customer_list:getListIdFromUserData(ord_grid, 'id_customer')} ,function(data)
        {
            prop_tb._orderOrdersGrid.parse(data);
            ...
            if(lastOrderSelID !== undefined && lastOrderSelID !== "" && lastOrderSelID!==0)
            {
    ...
    {
        prop_tb._orderProductGrid.clearAll(true);
        $.post("index.php?ajax=1&act=ord_orders_products_get&id_lang="+SC_ID_LANG, {id_order_list:prop_tb._orderOrdersGrid.getSelectedRowId()},function(data)
        {
