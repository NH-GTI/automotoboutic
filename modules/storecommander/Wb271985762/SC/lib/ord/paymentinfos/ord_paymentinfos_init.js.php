...
function displayPaymentInfos() {
    ...
    $.post('index.php?ajax=1&act=ord_<?php echo $subprop_name; ?>_get', {
        id_order_list : castListId(getListIdFromUserData(ord_grid, 'id_order'))
    },function (response) {
        prop_tb._PaymentInfosGrid.parse(response)
