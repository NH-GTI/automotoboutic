...
if (!defined('STORE_COMMANDER')) { exit; }
    ...
    function getRowsFromDB()
    {
        ...
        $sql = 'SELECT ocr.id_order_cart_rule, ocr.name as cart_rule_name, ocr.value, 
                o.id_order, o.reference, o.date_add, o.total_paid, o.total_products_wt, o.total_discounts_tax_incl,
                osl.name as status, c.id_customer, c.email, c.lastname, c.firstname, cr.code,
        ...
        foreach ($res as $ocr)
        {
            ...
            $xml .= '<cell>'.$ocr['total_discounts_tax_incl'].'</cell>';
...
<rows id="0">
    <head>
        <beforeInit>
            <call command="attachHeader"><param><![CDATA[#numeric_filter,#text_filter,#numeric_filter,#numeric_filter,#numeric_filter,#numeric_filter,#text_filter,#text_filter,#text_filter,#numeric_filter,#text_filter,#text_filter,#text_filter,#text_filter,#select_filter]]></param></call>
            <call command="attachFooter"><param><![CDATA[,,,#stat_total,#stat_total,#stat_total,#stat_total]]></param></call>
        </beforeInit>
        ...
        <column id="total_discounts_tax_incl" width="100" type="ro" align="left" sort="str"><?php echo _l('Total discounts inc. tax'); ?></column>
        <column id="total_paid" width="100" type="ro" align="left" sort="str"><?php echo _l('Total paid'); ?></column>
        <column id="total_products_wt" width="100" type="ro" align="left" sort="str"><?php echo _l('Total products inc. tax'); ?></column>
