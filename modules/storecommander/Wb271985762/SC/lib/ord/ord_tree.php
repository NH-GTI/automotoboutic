...
<?php
    createMenu();
?>
    statusselection=(Cookies.get('sc_ord_statusselection')!=null?Cookies.get('sc_ord_statusselection'):'');
    periodselection=(Cookies.get('sc_ord_periodselection')==null?'3days':Cookies.get('sc_ord_periodselection'));
...
?>
    ...
    ord_tb.attachEvent("onClick", function(id){
        ...
        if(id=='all') {
            ...
            Cookies.set('sc_ord_statusselection',statusselection, defaultCookieOptions);
            Cookies.set('sc_ord_periodselection','all', defaultCookieOptions);
            displayOrders();
        }
        ...
        if (filter_views_list[id]!= null && filter_views_list[id]!= undefined && filter_views_list[id]!= ''){
            ...
            Cookies.set('sc_ord_statusselection',statusselection, defaultCookieOptions);
            Cookies.set('sc_ord_periodselection',periodselection, defaultCookieOptions);
            displayFilters('displayOrders()');
        }
    });
...
?>
    ...
    function displayFilters(callback)
    {
        ...
        ord_filter.load("index.php?ajax=1&act=ord_filter_get&id_lang="+SC_ID_LANG+"&id_shop="+shopselection+"&"+new Date().getTime(),function(){
                ...
                var temp = Cookies.get('sc_ord_fromto_dates');
                ...
                var temp = Cookies.get('sc_ord_inv_fromto_dates');
                if(temp!=undefined && temp!=null && temp!="")
                {
                    var dates = temp.split("_");
                    var from = dates[0];
