...
if (_r('GRI_ORD_PROPERTIES_GRID_PRODUCT')) { ?>
    ...
    getTbSettingsButton(prop_tb, {'grideditor':<?php echo (int)_r('MEN_TOO_GRIDSSETTINGS'); ?>,'settings':0}, 'prop_product_', 1000);
...
?>
    ...
    function displayOrderProducts()
    {
        ...
        ajaxPostCalling(dhxLayout.cells('b'), prop_tb._orderProductGrid, loadUrl,
        {
            id_order_list: castListId(lastOrderSelIDs)
        }, function(data)
        {
