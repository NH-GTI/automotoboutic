...
?>
    ...
    getTbSettingsButton(prop_tb, {'grideditor':0,'settings':<?php echo (int)_r('MEN_TOO_SETTINGS'); ?>}, 'prop_seo_',1000);
...
function checkPixelSize(rId = null){
    ...
    all_rows.forEach(function(id){
        ...
        if(title_size > 0){
            ...
            prop_tb._pdtSeoGrid.cells(id,idxMetaTitlePixelSize).setValue(Math.round(title_in_px));
        ...
        if(description_size > 0){
            ...
            prop_tb._pdtSeoGrid.cells(id,idxMetaDescriptionPixelSize).setValue(Math.round(description_in_px));
