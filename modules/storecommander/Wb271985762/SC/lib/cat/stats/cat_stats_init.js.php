...
if (_r('GRI_CAT_PROPERTIES_GRID_STATS')) { ?>
...
function displayStats() {
    dhxLayout.cells('b').attachURL('index.php?ajax=1&act=cat_stats_get&stat_view=' + options_stats_view_selected, true, {list_id_product:cat_grid.getSelectedRowId()});
}
