            ...
            if ($id_category > 1)
            {
                ...
                if (Validate::isLoadedObject($category) && !$category->isRootCategoryForAShop())
                {
                    if (SCMS)
                    {
                        ...
                        ## using nleft & nright
                        $childrenCategories = $category->getAllChildren();
                        if($childrenCategories->getResults()) {
                            /**
                        ...
                        ## using id_parent
                        $childrenCategories = [];
                        categoryChildren($childrenCategories, $id_category);
                        if($childrenCategories) {
                            foreach ($childrenCategories as $childIdCategory) {
                                (new Category((int)$childIdCategory))->delete();
                            }
                        }
                    }
