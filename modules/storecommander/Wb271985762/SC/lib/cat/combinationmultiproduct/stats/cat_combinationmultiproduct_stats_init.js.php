...
function getCombinationMultiProductStats(options_multi_combi_stats_view_selected=null) {
    ...
    prop_tb._combinationsMultiProductStatLayout.cells('a').attachURL('index.php?ajax=1&act=cat_combinationmultiproduct_stats_get&stat_view=' + options_multi_combi_stats_view_selected, true, {id_product_attribute_list:prop_tb._combinationmultiproductGrid.getSelectedRowId()});
}