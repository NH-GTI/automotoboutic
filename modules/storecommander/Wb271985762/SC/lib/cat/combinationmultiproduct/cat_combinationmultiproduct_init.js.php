...
?>
    ...
    <?php if (Combination::isFeatureActive() && _r('GRI_CAT_PROPERTIES_GRID_COMBI_MULTI_PRODUCTS')) { ?>
    ...
    getTbSettingsButton(prop_tb, {'grideditor':<?php echo (int)_r('MEN_TOO_GRIDSSETTINGS'); ?>,'settings':0}, 'prop_combinationmultiproduct_',1000);
    ...
    function initCombinationMultiProduct()
    {
        if (needInitCombinationMultiProduct)
        {
            ...
            prop_tb.combimulprd_subproperties_tb.addButtonSelect("combimulprdSubProperties", 0, default_sub_combi[0], opts, default_sub_combi[1], default_sub_combi[1],false,true);
