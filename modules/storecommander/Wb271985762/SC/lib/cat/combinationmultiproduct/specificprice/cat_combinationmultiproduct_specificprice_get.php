...
if (!defined('STORE_COMMANDER'))
{
    ...
    $idlist = Tools::getValue('id_product_attribute_list', 0);
    $idlist_arr = explode(',', $idlist);
    $id_product_attribute_list = [];
    ...
    function getRowsFromDB()
    {
        ...
        $disabled_fields_by_id_speprice = [];
        $xml = '';
        foreach ($res as $specific_price)
        {
            ...
            $xml .= '<cell>'.($specific_price['price'] != -1 ? number_format($specific_price['price'], 2) : '-1').'</cell>';
...
<column id="price_exl_tax" width="65" type="ron" align="right" sort="int" format="<?php echo _s('CAT_PROD_PRICEWITHOUTTAX4DEC') ? '0.0000' : '0.00'; ?>"><?php echo _l('Price excl. Tax'); ?></column>
<column id="price_inc_tax" width="65" type="ron" align="right" sort="int" format="<?php echo _s('CAT_PROD_PRICEWITHTAX4DEC') ? '0.0000' : '0.00'; ?>"><?php echo _l('Price incl. Tax'); ?></column>
...
<column id="price_with_reduction_tax_excl" width="65" type="edn" align="left" sort="int" format="<?php echo _s('CAT_PROD_PRICEWITHOUTTAX4DEC') ? '0.0000' : '0.00'; ?>"><?php echo _l('Price tax excl after reduction'); ?></column>
<column id="price_with_reduction_tax_incl" width="65" type="edn" align="left" sort="int" format="<?php echo _s('CAT_PROD_PRICEWITHTAX4DEC') ? '0.0000' : '0.00'; ?>"><?php echo _l('Price tax incl after reduction'); ?></column>
