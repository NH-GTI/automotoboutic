...
echo '<script>'; ?>
    var dhxlRebuildLevelDepth_layout_layout = wRebuildLevelDepth.attachLayout("1C");

    var dhxlRebuildLevelDepth_cell = dhxlRebuildLevelDepth_layout_layout.cells('a');
    dhxlRebuildLevelDepth_cell.hideHeader();

    var dhxlRebuildLevelDepth_toolbar = dhxlRebuildLevelDepth_cell.attachToolbar();
    ...
    var dhxlRebuildLevelDepth_layout_grid = dhxlRebuildLevelDepth_cell.attachGrid();
    var all_ids = '';
