...
<?php
        ...
        echo '                prop_tb._featuresGrid.setCellExcellType(rId,idxCustom'.$lang['iso_code'].",'edtxt');";
                    ...
                    if (nValue!=oValue)
                    {
                        ...
                        $.each(p_ids, function(num, p_id){
                            ...
                            params.params["id_product_list"] = p_id;
    ...
    function displayFeatures(){
        ...
        $.post("index.php?ajax=1&act=cat_feature_productfeature_get&id_lang="+SC_ID_LANG+"&id_category="+catselection+"&filter="+featuresFilter+"&"+new Date().getTime(),{'id_product_list': tempIdList},function(data)
                {
