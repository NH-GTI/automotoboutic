            ...
            if(id=='combi_img_add')
            {
                ...
                if (products_ids != undefined && products_ids!=0)
                {
                    if (!dhxWins.isWindow("wProductImages"+products_ids))
                    {
                        ...
                        ll.cells('a').attachURL("index.php?ajax=1&act=cat_image_upload&is_attr=1&id_lang="+SC_ID_LANG, null, {product_list:products_ids, attr_list:products_attr_ids});
...
function displayCombiFastUpload()
{
    ...
    prop_tb._combi_imageFastUpload.attachURL("index.php?ajax=1&act=cat_image_upload&is_attr=1&id_lang="+SC_ID_LANG, null, {product_list:lastProductSelID, attr_list:products_attr_ids});
}
