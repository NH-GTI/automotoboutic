...
function getCombinationStats(options_combi_stats_view_selected = null) {
    ...
    prop_tb._combinationsStatLayout.cells('a').attachURL('index.php?ajax=1&act=cat_combination_stats_get&stat_view=' + options_combi_stats_view_selected, true, {id_product_attribute: prop_tb._combinationsGrid.getSelectedRowId()});
}