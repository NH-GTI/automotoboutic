            ...
            if (lastColumnRightClicked_CombinationsSpecificprices!=0 && clipboardValue_CombinationsSpecificprices!=null && clipboardType_CombinationsSpecificprices==lastColumnRightClicked_CombinationsSpecificprices)
            {
                ...
                if (selection!='' && selection!=null)
                {
                    ...
                    for(const rowId of selArray) {
                        let oldValue = prop_tb._combinationsSpecificPricesGrid.cells(rowId,lastColumnRightClicked_CombinationsSpecificprices).getValue();
                        prop_tb._combinationsSpecificPricesGrid.cells(rowId,lastColumnRightClicked_CombinationsSpecificprices).setValue(clipboardValue_CombinationsSpecificprices);
                        prop_tb._combinationsSpecificPricesGrid.cells(rowId,lastColumnRightClicked_CombinationsSpecificprices).cell.wasChanged=true;
                        prop_tb._combinationsSpecificPricesGrid.callEvent('onEditCell',[2, rowId, lastColumnRightClicked_CombinationsSpecificprices, clipboardValue_CombinationsSpecificprices, oldValue]);
                    }
                }
            }
        }
