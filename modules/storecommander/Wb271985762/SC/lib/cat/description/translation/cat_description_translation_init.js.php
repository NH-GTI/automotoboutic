...
if (count($languages) > 1)
{
    ...
    <?php } ?>
            ...
            prop_tb.desc_subproperties_tb.setItemState("desc_transl_twodesc", 1);
            <?php } ?>
            ...
            prop_tb.desc_subproperties_tb.attachEvent("onClick", function(id){
                ...
                if (prop_tb.desc_subproperties_tb.getParentId(id) === 'desc_translang'){
            ...
            prop_tb.desc_subproperties_tb.attachEvent("onStateChange",function(id,state){
                switch(id) {
                    case 'desc_transl_twodesc':
                        prop_tb._descriptionsLayout.cells('b').getFrame().contentWindow.hideOrShowAllDesc();
                        break;
                }
            });

            prop_tb._descriptionsLayout.attachEvent("onPanelResizeFinish", function(){
                saveParamUISettings('desc_translation', Number(prop_tb._descriptionsLayout.cells('b').getWidth()));
            });
        }
    }
