...
if (!defined('STORE_COMMANDER')) { exit; }
    ...
    if (!$res)
    {
        ...
        $newcategory->id_parent = SCI::getConfigurationValue('PS_ROOT_CATEGORY');
        $newcategory->level_depth = 1;
        $newcategory->active = 0;
        $newcategory->position = Category::getLastPosition(SCI::getConfigurationValue('PS_ROOT_CATEGORY'), 0);
        foreach ($languages as $lang)
        {
            $newcategory->link_rewrite[$lang['id_lang']] = 'sc_recycle_bin';
