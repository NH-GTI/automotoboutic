...
{
    $grids['grid_reference'] .= ',nb_parts_compatibilities,parts_compatibilities';
    $grids['grid_everyparts'] = 'id,name,reference,ean13,nb_parts_compatibilities,parts_compatibilities';
}
...
{
    $grids['grid_shippingbo'] = 'id,image,quantity,active,is_locked,id_sbo,reference,name,type_sbo';
    if (version_compare(_PS_VERSION_, '1.7.8.0', '>='))
    {
        $grids['grid_shippingbo'] = str_replace(',type_sbo', ',product_type,type_sbo', $grids['grid_shippingbo']);
    }
}
