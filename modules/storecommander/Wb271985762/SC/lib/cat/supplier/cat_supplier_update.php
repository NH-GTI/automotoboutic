                    ...
                    if (!empty($combinations))
                    {
                        foreach ($combinations as $combination)
                        {
                            ...
                            if (empty($id_product_supplier))
                            {
                                ...
                                $product_supplier_entity = new ProductSupplier($id_product_supplier);

                            }


                            ## update default value for combination by default supplier
                            $combination->wholesale_price = $product_supplier_entity->product_supplier_price_te;
                            if(version_compare(_PS_VERSION_, '8.1', '<')) {
                                $combination->supplier_reference = $product_supplier_entity->product_supplier_reference;
                            }
