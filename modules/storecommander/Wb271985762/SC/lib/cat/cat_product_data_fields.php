...
$colSettings['ecotax'] = array('text' => _l('EcoTax').(SCI::isEcotaxHasTaxRate() ? ' '._l('Tax incl.') : ''), 'width' => 50, 'align' => 'right', 'type' => 'edn', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter', 'format' => '0.00');
...
$conditionOptions = array('new' => _l('New'), 'used' => _l('Used'), 'refurbished' => _l('Refurbished'));
if(version_compare(_PS_VERSION_, '1.7.8.0', '>=')){
    $producConditions = new \PrestaShop\PrestaShop\Core\Form\ChoiceProvider\ProductConditionChoiceProvider(Context::getContext()->getTranslator());
    $conditionOptions = array_flip($producConditions->getChoices());
}
$colSettings['condition'] = array('text' => _l('Condition'), 'width' => 65, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => $conditionOptions);
...
$colSettings['available_date'] = array('text' => _l('Available date'), 'width' => 80, 'align' => 'right', 'type' => 'dhxCalendarA', 'sort' => 'date', 'color' => '', 'filter' => '#select_filter');
$colSettings['visibility'] = array('text' => _l('Visibility'), 'width' => 65, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array('both' => _l('Everywhere'), 'catalog' => _l('Catalog only'), 'search' => _l('Search only'), 'none' => _l('Nowhere')));
...
{
    $colSettings['nb_parts_compatibilities'] = array('text' => _l('Nb. compat. associated'), 'width' => 40, 'align' => 'center', 'type' => 'ro', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter');
    $colSettings['parts_compatibilities'] = array('text' => _l('Compatibilities (copy/paste)'), 'width' => 100, 'align' => 'left', 'type' => 'coro', 'sort' => 'na', 'color' => '', 'filter' => '#text_filter');
}
...
{
    $colSettings['id_sbo'] = array('text' => _l('Id Shippingbo'), 'width' => 120, 'align' => 'left', 'type' => 'ron', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
    $colSettings['is_locked'] = array('text' => _l('Enable Shippingbo synchronization'),  'width' => 45, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array(
        Sc\Service\Shippingbo\Shippingbo::SBO_PRODUCT_IS_UNLOCKED => _l('Yes'),
        Sc\Service\Shippingbo\Shippingbo::SBO_PRODUCT_IS_LOCKED => _l('No')
    ));
    $colSettings['type_sbo'] = array('text' => _l('Type Shippingbo'), 'width' => 120, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter');
}