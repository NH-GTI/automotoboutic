...
$formAll = [
    ...
    'account_api' => [
        ...
        'label' => _l('%s access API configuration', null, ['Shippingbo']),
        'id' => 'sbo_account',
        'className' => 'formApi',
        'list' => [
            [
                'type' => 'hidden',
                'name' => 'id_account',
                'value' => $shippingBoAccount->getId(),
            ],
            [
                'type' => 'label',
                'label' => _l('Configuration name'),
            ],
            [
                'inputWidth' => 274,
                'type' => 'input',
...
if (SCMS)
{
    unset($formAll['import'],$formAll['export'],$formAll['unit']);
}
else
{
    unset($formAll['account_api']['list'][1]);
    $formAll['account_api']['list'][2]['type'] = 'hidden';
    $formAll['account_api']['list'] = array_values($formAll['account_api']['list']);
}
