...
function displayGroups(all_groups = '', params = '')
{
    ...
    $.post("index.php?ajax=1&act=cat_win-attribute_group_get&id_lang="+SC_ID_LANG+"&all_groups="+all_groups+"&params="+params+"&"+new Date().getTime(),function(data)
    {
        wAttributes.gridGroups.parse(data);
