...
?>
    ...
    prop_tb.addButton('message_exportcsv',1000, '', 'fad fa-file-csv green', 'fad fa-file-csv green');
    prop_tb.setItemToolTip('message_exportcsv','<?php echo _l('Export grid to clipboard in CSV format for MSExcel with tab delimiter.', 1); ?>');
    ...
    function setPropertiesPanel_message(id){
        if (id=='message')
        {
            ...
            prop_tb.showItem('message_exportcsv');
        ...
        if (id=='message_exportcsv'){
            displayQuickExportWindow(prop_tb._messageGrid,1);
        }
