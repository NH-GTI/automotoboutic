                                                ...
                                                <td style="width:20px; text-align:center;">
                                                    ...
                                                    <script>
                                                        $(document).ready(function(){
                                                            $("#check_all_states").on("change", function() {
                                                                if($(this).is(":checked")) {
                                                                    $(".check_states").prop("checked",true);
                                                                    $("#check_all_states_text").html("' . _l('Uncheck all') . '");
                                                                }
                                                                else
                                                                {
                                                                    $(".check_states:checkbox").prop("checked",false);
                                                                   $("#check_all_states_text").html("' . _l('Check all') . '");
                                                                }
                                                            })
                                                            
                                                            if($(".check_states").length === $(".check_states:checked").length)
                                                            {
                                                                $("#check_all_states").prop("checked",true);
                                                                $("#check_all_states_text").html("' . _l('Uncheck all') . '");
                                                            }
                                                        });
                                                    </script>
