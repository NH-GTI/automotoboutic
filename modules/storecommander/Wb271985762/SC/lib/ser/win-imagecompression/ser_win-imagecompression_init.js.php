...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="'.SC_CSSDHTMLX.'"/>
    <link rel="stylesheet" href="'.SC_CSSSTYLE.'"/>
    <link rel="stylesheet" href="lib/css/fontawesome/all.css"/>
    <script src="'.SC_JSDHTMLX.'">
    <script src="lib/js/message.js">
    <script src="'.SC_JQUERY.'">
    <script src="'.SC_JSFUNCTIONS.'">
    <script>
