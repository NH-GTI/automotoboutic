...
?>
    ...
    function displayCmsSeo()
    {
        ...
        $.post('index.php?ajax=1&act=cms_seo_get',
        {
            id_lang: SC_ID_LANG,
            idlist: castListId(getListIdFromUserData(cms_grid, 'id_cms'))
        },function(data)
        {
    ...
    {
        prop_tb._googleAdwords.setHeight(150);
        prop_tb._googleAdwords.attachURL("index.php?ajax=1&act=cms_seo_add_get&id_lang="+SC_ID_LANG,function(data){});
    }
