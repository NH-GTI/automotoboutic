...
$solution_list = array(
    ...
    array(
        ...
        'actions' => array(
            ...
            'CAT_PRODUCT_IMG_WITHOUT_LEGEND',
            'CAT_PRODUCT_TAX_DELETED',
            'MUL_DAT_GHOST_SHOP',
            'MUL_DAT_MISSING_SHOP',
            'CAT_PROD_MISSING_COVER_IMAGE',
    ...
    array(
        ...
        'logo' => '<img src="lib/img/fixmyps-pdf.png"/>',
        'actions' => array(
            'CAT_PROD_GHOST_CATEGORY_PRODUCT',
            'CAT_PROD_GHOST_PRODUCT_ATTRIBUTE',
            'CAT_PROD_WITHOUT_CATEGORY',
    ...
    array(
        ...
        'logo' => '<img src="lib/img/security.png"/>',
        'actions' => array(
...
if (\Sc\Service\Service::exists('shippingbo')) {
    $solution_list[] = array(
        'id' => 'prestashop_shippingbo',
        'brand' => ucfirst(_l('logistic')) . _l(':') . ' ' . _l('Shippingbo'),
        'logo' => '<img src="lib/img/shippingbo/sbo-45x45.png"/>',
        'external_link' => 'https://www.shippingbo.com/',
        'actions' => array(
            'CAT_ATTR_ASSOCIATION_SHOP', // List of combinations with no association in ps_product_attribute_shop for their default shop
            'CAT_CAT_GHOST_CAT_PROD_PROD_DUP', // List of duplicate products present in ps_category_product
            'CAT_PRODUCT_ASSOCIATION_SHOP', // List of products where id_shop_default not in ps_product_shop
            'CAT_PROD_NOT_SAME_ATTRIBUTES', // List of products with combinations with not same attributes groups.
            'CAT_PROD_WITHOUT_DEFAULT_COMBI', // List of products without default combination
            'CAT_AND_PROD_NOT_SHARING_SHOP', // List of products and categories not sharing shops
            'CAT_COMBI_GHOST_MS', // List of combination in ps_product_attribute but not in ps_product_attribute_shop
            'CAT_COMBI_PRODUCT_NOT_SHOP_SHARED', // List of products not shared with a shop when at least one combination of that product is shared with that shop
            'CAT_PROD_WITHOUT_CATEGORY',
            'CAT_PRODUCT_DUPLICATE_REFERENCE',
            'CAT_PRODUCT_DUPLICATE_EAN',
            'CAT_COMBI_DUPLICATE_REFERENCE',
            'CAT_COMBI_DUPLICATE_EAN', //List of id_product_attribute with same EAN13
            'CAT_PRODUCT_COMBI_DUPLICATE_EAN',
            'CAT_PRODUCT_VALIDATE_EAN_FORMAT',
            'CAT_PROD_WITHOUT_PRODUCT_TYPE',
            'CAT_STK_GHOST_STOCK_AVAILABLE',
