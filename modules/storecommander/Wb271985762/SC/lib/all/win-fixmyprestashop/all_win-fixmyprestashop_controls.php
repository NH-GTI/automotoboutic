...
$shop_tables = [
    ['table' => 'attribute_group', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'attribute', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'carrier', 'vs_min' => '', 'vs_max' => ''],

    ['table' => 'category', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'cms_block', 'vs_min' => '', 'vs_max' => '1.6.1.0'],
    ['table' => 'cms', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'contact', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'country', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'currency', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'employee', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'feature', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'group', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'image', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'lang', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'manufacturer', 'vs_min' => '', 'vs_max' => ''],

    ['table' => 'referrer', 'vs_min' => '', 'vs_max' => '1.7.9.9'],
    ['table' => 'scene', 'vs_min' => '', 'vs_max' => '1.7.0.0'],
    ['table' => 'store', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'supplier', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'tax_rules_group', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'warehouse', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'webservice_account', 'vs_min' => '', 'vs_max' => ''],
    ['table' => 'zone', 'vs_min' => '', 'vs_max' => ''],
];
...
$controls['CAT_PROD_MISSING_PRODUCT_LANG'] = [
...
$controls['CAT_PROD_MISSING_PRODUCT_LANG_MS'] = [
...
$controls['CAT_PROD_MISSING_PRODUCT_INFORMATION'] = [
...
$controls['CAT_PROD_MISSING_PRODUCT_INFORMATION_MS'] = [
...
$controls['CAT_PROD_GHOST_CATEGORY_PRODUCT'] = [
...
$controls['CAT_PROD_GHOST_PRODUCT_ATTRIBUTE'] = [
...
$controls['CAT_COMBI_GHOST_STOCK'] = [
...
$controls['CAT_PROD_WITHOUT_CATEGORY'] = [
...
$controls['CAT_PROD_WITHOUT_DEFAULT_CATEGORY'] = [
...
$controls['CAT_PROD_PRODUCT_WITHOUT_LINK_REWRITE'] = [
...
$controls['CAT_ATTR_MISSING_ATTRIBUTE_LANG'] = [
...
$controls['CAT_ATTR_GHOST_ATTRIBUTE'] = [
...
$controls['CAT_ATTR_MISSING_GROUP_ATTRIBUTE_LANG'] = [
...
$controls['CAT_ATTR_GHOST_GROUP_ATTRIBUTE'] = [
...
$controls['TRP_CAR_MISSING_CARRIER_LANG'] = [
...
$controls['TRP_CAR_MISSING_CARRIER_LANG_MS'] = [
...
$controls['TRP_CAR_GHOST_CARRIER'] = [
...
$controls['TRP_CAR_GHOST_CARRIER_MS'] = [
...
$controls['CAT_CAT_MISSING_CAT_LANG'] = [
...
$controls['CAT_CAT_MISSING_CAT_LANG_MS'] = [
...
$controls['CAT_CAT_GHOST_CAT_PROD'] = [
...
$controls['CAT_ATTR_ASSOCIATION_SHOP'] = [
...
$controls['CAT_CAT_GHOST_CAT_PROD_PROD_DUP'] = [
...
$controls['TRP_CTY_MISSING_COUNTRY_LANG'] = [
...
$controls['CAT_PRODUCT_ASSOCIATION_SHOP'] = [
...
$controls['TRP_CTY_GHOST_COUNTRY'] = [
...
$controls['CAT_FEA_MISSING_FEATURE_LANG'] = [
...
$controls['CAT_FEA_GHOST_FEATURE'] = [
...
$controls['CAT_FEA_GHOST_CAT_PROD'] = [
...
$controls['CAT_PRODUCT_IMG_POSITIONS'] = [
...
$controls['CAT_PRODUCT_IMG_WITHOUT_LEGEND'] = [
    'key' => 'CAT_PRODUCT_IMG_WITHOUT_LEGEND',
    'version_min' => '',
    'version_max' => '',
    'tools' => 'Catalog',
    'section' => 'Product',
    'name' => 'Check product images without legend',
    'description' => 'List of product images with legend empty or null',
    'segment_params' => [
        'value_separator' => '_',
        'index_of_value_to_get' => '0',
        'access' => '-catalog-',
...
$controls['CAT_FEA_MISSING_FEATURE_VALUE_LANG'] = [
...
$controls['CAT_FEA_GHOST_FEATURE_VALUE'] = [
...
$controls['CUS_GRP_MISSING_GROUP_LANG'] = [
...
$controls['CAT_PRODUCT_TAX_DELETED'] = [
...
$controls['CAT_MAN_MISSING_MANUFACTURER_LANG'] = [
...
$controls['CAT_MAN_GHOST_MANUFACTURER'] = [
...
$controls['CAT_SUP_MISSING_SUPPLIER_LANG'] = [
...
$controls['CAT_SUP_GHOST_SUPPLIER'] = [
...
$controls['CAT_TAX_MISSING_TAX_LANG'] = [
...
$controls['GEN_ATH_MISSING_ATTACHMENT_LANG'] = [
...
$controls['GEN_ATH_GHOST_ATTACHMENT'] = [
...
$controls['GEN_CMS_MISSING_CMS_BLOCK_LANG'] = [
...
$controls['GEN_CMS_GHOST_CMS_BLOCK'] = [
...
$controls['GEN_CMS_MISSING_CMS_CATEGORY_LANG'] = [
...
$controls['GEN_CMS_GHOST_CMS_CATEGORY'] = [
...
$controls['GEN_CMS_MISSING_CMS_LANG'] = [
...
$controls['CMD_STA_MISSING_ORDER_STATE_LANG'] = [
...
$controls['CMD_STA_GHOST_ORDER_STATE'] = [
...
$controls['CAT_STK_GHOST_STOCK_AVAILABLE'] = [
...
$controls['CAT_PROD_MISSING_COVER_IMAGE'] = [
...
$controls['CAT_PROD_CUSTOM_FEATURE'] = [
...
$controls['CAT_PROD_DESC_HIDDEN_CARAC'] = [
...
$controls['CAT_PROD_DIFF_ADVANCEDSTOCKS_MODE'] = [
...
$controls['CAT_ATTR_GHOST_ATTRIBUTE_IN_WAREHOUSE'] = [
...
$controls['CAT_PROD_PRODUCT_WITH_COMBI_IN_WAREHOUSE'] = [
...
$controls['CAT_SUP_GHOST_PRODUCT_COMBI_SUPPLIER'] = [
...
$controls['CAT_PROD_NOT_SAME_ATTRIBUTES'] = [
...
$controls['CAT_PROD_LANG_WITH_EMPTY_SHOP'] = [
...
$controls['MUL_DAT_EMPTY_ID_SHOP'] = [
...
$controls['MUL_DAT_LANG_EMPTY_ID_SHOP'] = [
...
$controls['CAT_PROD_WITHOUT_DEFAULT_COMBI'] = [
...
$controls['CAT_AND_PROD_NOT_SHARING_SHOP'] = [
...
$controls['CAT_COMBI_PRODUCT_NOT_SHOP_SHARED'] = [
...
$controls['CAT_COMBI_WITHOUT_STOCK_ROW'] = [
...
$controls['CAT_PRODUCT_WITHOUT_STOCK_ROW'] = [
...
$controls['CAT_PRODUCT_IMG_SHOP_EMPTY_PRODUCT'] = [
...
$controls['CAT_PRODUCT_PRICE_TOO_LOW'] = [
    'key' => 'CAT_PRODUCT_PRICE_TOO_LOW',
    'version_min' => '',
    'version_max' => '',
    'tools' => 'Catalog',
    'section' => 'Product',
    'name' => 'Products with price too low',
    'description' => 'List of products for which the wholesale price is higher than the price excluding tax',
    'segment_params' => [
        'value_separator' => '_',
        'index_of_value_to_get' => '0',
        'access' => '-catalog-',
...
$controls['CAT_PROD_MISSING_IMAGE_LANG'] = [
...
$controls['CAT_STK_TOO_MUCH_COMBI_STOCK_AVAILABLE'] = [
...
if (
    ...
    && (!defined('SC_MultiplesFeatures_ACTIVE') || !SCI::moduleIsInstalled('pm_multiplefeatures'))
) {
    $controls['CAT_FEA_DOUBLE_PRODUCT'] = [
...
$controls['CAT_FEA_FEATURE_VALUE_NOTEXIST'] = [
...
$controls['CAT_PROD_TODO_IMPORT_CATEGORY'] = [
...
$controls['CAT_PRODUCT_DUPLICATE_REFERENCE'] = [
...
$controls['CAT_PRODUCT_DUPLICATE_NAME'] = [
...
$controls['CAT_PRODUCT_DUPLICATE_UPC'] = [
...
$controls['CAT_PRODUCT_DUPLICATE_EAN'] = [
...
$controls['CAT_COMBI_DUPLICATE_REFERENCE'] = [
...
$controls['CAT_COMBI_DUPLICATE_UPC'] = [
...
$controls['CAT_COMBI_DUPLICATE_EAN'] = [
...
$controls['CAT_PRODUCT_COMBI_DUPLICATE_EAN'] = [
...
$controls['CAT_PRODUCT_COMBI_DUPLICATE_REFERENCE'] = [
...
$controls['CAT_PRODUCT_COMBI_DUPLICATE_UPC'] = [
...
$controls['CAT_PRODUCT_VALIDATE_UPC_FORMAT'] = [
...
$controls['CAT_PRODUCT_VALIDATE_EAN_FORMAT'] = [
...
$controls['CUS_DB_DUPLICATE_EMAIL'] = [
...
$controls['CAT_SEO_DUPLICATE_META_DESC'] = [
...
$controls['CAT_SEO_DUPLICATE_META_TITLE'] = [
...
$controls['CAT_PROD_EMPTY_CUSTOM_FEATURE'] = [
...
$controls['SEC_FIL_INSTALL_LICENCES'] = [
...
$controls['SEC_PWD_SAME_PASSWORD'] = [
...
$controls['SEC_PWD_EMAIL_TEMPLATE_PASSWORD'] = [
...
$controls['SEC_FIL_PHPUNIT_BREACH'] = [
...
$controls['SEC_FRONT_CUSTOMER_FORM_BREACH'] = [
...
$controls['CAT_SEO_IMAGE_COMPRESSION'] = [
...
$controls['GEN_DB_MANY_PAGENOTFOUND'] = [
    'key' => 'GEN_DB_MANY_PAGENOTFOUND',
    'version_min' => '',
    'version_max' => '',
    'tools' => 'General',
    'section' => 'Database',
    'name' => ['Number of lines in ps_pagenotfound (+%s)', ['10000']],
    'description' => 'Check number of lines in ps_pagenotfound table',
];
$controls['GEN_DB_MANY_LOG'] = [
    'key' => 'GEN_DB_MANY_LOG',
    'version_min' => '',
    'version_max' => '',
    'tools' => 'General',
    'section' => 'Database',
    'name' => ['Number of lines in ps_log (+%s)', ['10000']],
    'description' => 'Check number of lines in ps_log table',
];
$controls['CUS_DB_UNUSED_CART_OVER_TWO_YEAR'] = [
...
$controls['CUS_DB_CART_RULE_OBSOLETE'] = [
...
$controls['CAT_PROD_DUPLICATE_COMBINATION'] = [
...
$controls['SEC_UNINSTALLED_MODULES'] = [
...
if ($notValid)
{
    $controls['SEC_MODULE_LGSEOREDIRECT'] = [
        'key' => 'SEC_MODULE_LGSEOREDIRECT',
        'version_min' => '',
        'version_max' => '',
        'tools' => 'Security',
        'section' => 'Modules',
        'name' => ['Check if module %s contains a critical security breach', ['lgseoredirect']],
...
if ($notValid)
{
    $controls['SEC_MODULE_PRODUCTCOMMENTS'] = [
        'key' => 'SEC_MODULE_PRODUCTCOMMENTS',
        'version_min' => '',
        'version_max' => '',
        'tools' => 'Security',
        'section' => 'Modules',
        'name' => ['Check if module %s contains a critical security breach', [_l('productcomments')]],
        'description' => 'Verify if the module version contains a critical security breach',
    ];
}

$controls['SEC_MODULE_SCAFFILIATION'] = [
    'key' => 'SEC_MODULE_SCAFFILIATION',
    'version_min' => '',
    'version_max' => '',
    'tools' => 'Security',
    'section' => 'Modules',
    'name' => ['Check module %s', [_l('Affiliation program')]],
    'description' => ['Verify if the module version of %s is up to date', [_l('Affiliation program')]],
];
if (file_exists(_PS_MODULE_DIR_.'scexportcustomers/scexportcustomers.php'))
{
    $controls['SEC_MODULE_SCEXPORTCUSTOMERS'] = [
        'key' => 'SEC_MODULE_SCEXPORTCUSTOMERS',
        'version_min' => '',
        'version_max' => '',
        'tools' => 'Security',
        'section' => 'Modules',
        'name' => ['Check module %s', [_l('Customers export')]],
        'description' => ['Verify if the module version of %s is up to date', [_l('Customers export')]],
    ];
}
$controls['SEC_MODULE_SCPDFCATALOG'] = [
    'key' => 'SEC_MODULE_SCPDFCATALOG',
    'version_min' => '',
    'version_max' => '',
    'tools' => 'Security',
    'section' => 'Modules',
    'name' => ['Check module %s', [_l('PDF Catalog')]],
    'description' => ['Verify if the module version of %s is up to date', [_l('PDF Catalog')]],
];
if (file_exists(_PS_MODULE_DIR_.'scquickaccounting/scquickaccounting.php'))
{
    $controls['SEC_MODULE_SCQUICKACCOUNTING'] = [
        'key' => 'SEC_MODULE_SCQUICKACCOUNTING',
        'version_min' => '',
        'version_max' => '',
        'tools' => 'Security',
        'section' => 'Modules',
        'name' => ['Check module %s', [_l('Order Export Pro')]],
        'description' => ['Verify if the module version of %s is up to date', [_l('Order Export Pro')]],
    ];
}
$controls['CAT_PROD_WITHOUT_PRODUCT_TYPE'] = [
    'key' => 'CAT_PROD_WITHOUT_PRODUCT_TYPE',
    'version_min' => '1.7.8',
    'version_max' => '',
    'tools' => 'Catalog',
    'section' => 'Product',
    'name' => ['Check products without default type'],
    'description' => ['Verify if products have a default type'],
];

$controls['SEC_CUSTOMER_DEFAULT_INSTALL'] = [
    'key' => 'SEC_CUSTOMER_DEFAULT_INSTALL',
    'version_min' => '',
    'version_max' => '',
    'tools' => 'Security',
    'section' => 'Customer',
    'name' => ['Check if dummy customer account present'],
    'description' => ['Verify if the default first customer created by %s installation is still present', ['PrestaShop']],
];

$controls['SEC_ADMIN_FOLDER'] = [
...
if ($notValid)
{
    $controls['SEC_MODULE_PAYPAL'] = [
        'key' => 'SEC_MODULE_PAYPAL',
        'version_min' => '',
        'version_max' => '',
        'tools' => 'Security',
        'section' => 'Modules',
        'name' => ['Check if module %s contains a critical security breach', ['PayPal']],
        'description' => 'Verify if the module version contains a critical security breach',
    ];
}

if (file_exists(_PS_MODULE_DIR_.'scfixmyprestashop/scfixmyprestashop.php'))
{
    $controls['SEC_MODULE_SCFIXMYPRESTASHOP'] = [
        'key' => 'SEC_MODULE_SCFIXMYPRESTASHOP',
        'version_min' => '',
        'version_max' => '',
        'tools' => 'Security',
        'section' => 'Modules',
        'name' => ['Check module %s', [_l('Fix My Prestashop')]],
        'description' => ['Verify if the module version of %s is up to date', [_l('Fix My Prestashop')]],
    ];
}
