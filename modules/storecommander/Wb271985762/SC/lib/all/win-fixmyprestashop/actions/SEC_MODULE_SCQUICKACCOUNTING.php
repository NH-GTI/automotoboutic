    ...
    case 'do_check':
        ...
        if (file_exists($modulePath.$moduleName.'.php'))
        {
            ...
            <div class="current_panel" style="padding: 20px;height: 100%;overflow: auto;">
                ...
                <?php
                echo '<p>'._l('The %s module in your back office is now integrated into %s via the "%s" menu.', null, array('<b>'.$moduleNameLiteral.'</b>', 'Store Commander', _l('Orders').' > '._l('CSV Export'))).'</p>'; ?>
