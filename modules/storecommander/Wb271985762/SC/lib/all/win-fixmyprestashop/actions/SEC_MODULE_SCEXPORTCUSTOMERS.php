    ...
    case 'do_check':
        ...
        if (file_exists($modulePath.$moduleName.'.php'))
        {
            ...
            <div class="current_panel" style="padding: 20px;height: 100%;overflow: auto;">
                ...
                <?php
                echo '<p>'._l('The %s module in your back office is now integrated into %s via the "%s" menu.', null, array('<b>'.$moduleNameLiteral.'</b>', 'Store Commander', _l('Customers').' > '._l('CSV Export'))).'</p>'; ?>
                <div class="main_list" style="clear: both">
                <?php echo '<ol>
                    <li>'._l('If you ordered a module modification please contact us at <br>%s or by %s<br>before uninstalling and deleting the module', null, array('<a href="mailto:support@storecommander.com">support@storecommander.com</a>', '<a href="javascript:void(0);" onclick="Intercom(\'showNewMessage\');">'._l('tchat').'</a>')).'</li>
                    <li>
                        <button class="btn_red" onclick="'.$current_control_filename.'_backup(this)">'._l('Click to download a backup of the current module').' </button> <i class="far fa-spinner fa-spin" style="display:none"></i>
                        <br>
