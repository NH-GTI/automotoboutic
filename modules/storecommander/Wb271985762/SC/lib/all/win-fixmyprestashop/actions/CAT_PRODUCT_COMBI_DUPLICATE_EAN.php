...
if (!empty($post_action) && $post_action == 'do_check')
{
    ...
    if (!empty($itemFound))
    {
        ...
        ob_start(); ?>
        <script>
            var rowsProductCombiSameEAN = dhxlSCExtCheck.tabbar.cells("table_<?php echo $action_name; ?>").attachLayout("2E");
            ...
            gridDetailsProductCombiSameEAN.setInitWidths("100,60,200,150,100,60,100,200");
