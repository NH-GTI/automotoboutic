    ...
    ?>
        ...
        <column id="table" width="80" type="coro" align="left" sort="str"><?php echo _l('Table'); ?>
            ...
            { ?>
                ...
                <option value="product_html">product - (HTML) <?php echo _l('Modifications applied automatically'); ?></option>
                <option value="product_lang">product_lang - <?php echo _l('Modifications applied automatically'); ?></option>
                <option value="product_lang_html">product_lang - (HTML) <?php echo _l('Modifications applied automatically'); ?></option>
