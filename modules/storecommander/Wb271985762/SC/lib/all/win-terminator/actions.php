...
$actions['delsmartycache'] = array(
    ...
    'type' => 'files',
    'currently' => '$terminatorTools->sizeFormat($terminatorTools->getDirectorySize(_PS_CACHE_DIR_ . \'smarty/compile/\', \'size\')'.
        ' + $terminatorTools->getDirectorySize(_PS_CACHE_DIR_ . \'smarty/cache/\', \'size\'))',
    'param' => 0,
    'default_value' => '',
...
$actions['delcachefs'] = array(
    ...
    'type' => 'files',
    'currently' => '$terminatorTools->sizeFormat($terminatorTools->getDirectorySize(_PS_CACHE_DIR_ . "cachefs/", \'size\'))',
    'param' => 0,
    'default_value' => '',
...
$actions['delcachetcpdf'] = array(
    ...
    'type' => 'files',
    'currently' => '$terminatorTools->sizeFormat($terminatorTools->getDirectorySize(_PS_CACHE_DIR_ . "tcpdf/", \'size\'))',
    'param' => 0,
    'default_value' => '',
