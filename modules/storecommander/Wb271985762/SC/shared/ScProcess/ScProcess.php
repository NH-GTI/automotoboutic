...
use Exception;
use Sc\ScProcess\Traits\ScProcessTrait;
...
class ScProcess
{
    ...
    public function __construct(ScProcessInterface $process)
    {
    ...
    public function run()
    {
        ...
        while ($continue)
        {
            ...
            {
                $this->process->sendResponse('error',$e);
            }
        }
