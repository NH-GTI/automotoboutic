<table style="text-align:justify;">
	...
	<tr>
		<td width="15%">&nbsp;</td>
		<td width="70%" style="font-size:40px; text-align:center; ">{l s='gift offer by' mod='ndk_advanced_custom_fields' } {if $recipient->who_offers == ''}{$customer->firstname} {$customer->lastname}{else}{$recipient->who_offers}{/if}</td>
		<td width="15%">&nbsp;</td>
	</tr>
