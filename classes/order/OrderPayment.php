...
class OrderPaymentCore extends ObjectModel
{
    ...
    public function add($autodate = true, $nullValues = false)
    {
            ...
            PrestaShopLogger::addLog('PaymentModule::Order - Autodate', 1, null, 'Cart', $autodate, true);
        if (parent::add($autodate, $nullValues)) {
		PrestaShopLogger::addLog('PaymentModule::Order - Autodate Parent Add', 1, null, 'Cart', $autodate, true);
	}
        if (parent::add($autodate, $nullValues)) {
            Hook::exec('actionPaymentCCAdd', ['paymentCC' => $this]);

            PrestaShopLogger::addLog('PaymentModule::Order - Hook', 1, null, 'Cart', 1, true);
            return true;
        }
