...
abstract class PaymentModuleCore extends Module
{
    ...
    public function validateOrder(
        ...
        if (Configuration::get('PS_TAX_ADDRESS_TYPE') == 'id_address_delivery') {
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 1', 1, null, 'Cart', (int) $id_cart, true);
        ...
        if ($secure_key !== false && $secure_key != $this->context->cart->secure_key) {
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 2', 1, null, 'Cart', (int) $id_cart, true);
        ...
        $cart_total_paid = (float) Tools::ps_round(
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 3', 1, null, 'Cart', (int) $id_cart, true);
        ...
        if ($order_status->logable && (number_format($cart_total_paid, $comp_precision) !== number_format($amount_paid, $comp_precision))) {
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 4', 1, null, 'Cart', (int) $id_cart, true);
        foreach ($package_list as $id_address => $packageByAddress) {
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 5', 1, null, 'Cart', (int) $id_cart, true);
        ...
        if (self::DEBUG_MODE) {
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Order logable', 1, null, 'Cart', $order_status->logable, true);
	    ...
	    if(!isset($order)){
                ...
                PrestaShopLogger::addLog('PaymentModule::validateOrder - Isset order false', 1, null, 'Cart', (int) $id_cart, true);
	    }
	    else if(!$order->addOrderPayment($amount_paid, null, $transaction_id)){
		     
	    PrestaShopLogger::addLog('PaymentModule::validateOrder - Add order payment false', 1, null, 'Cart', (int) $id_cart, true);
	    }
	    else {
	
	    PrestaShopLogger::addLog('PaymentModule::validateOrder - Both false', 3, null, 'Cart', (int) $id_cart, true);
	    }
        ...
        $products = $this->context->cart->getProducts();
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 6', 1, null, 'Cart', (int) $id_cart, true);
        // Make sure CartRule caches are empty
        CartRule::cleanCache();
        foreach ($order_detail_list as $key => $order_detail) {
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 7', 1, null, 'Cart', (int) $id_cart, true);
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 8', 1, null, 'Cart', (int) $id_cart, true);
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 9', 1, null, 'Cart', (int) $id_cart, true);
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 10', 1, null, 'Cart', (int) $id_cart, true);
        ...
        Hook::exec(
            ...
            PrestaShopLogger::addLog('PaymentModule::validateOrder - Step 11', 1, null, 'Cart', (int) $id_cart, true);
        return true;
    }
